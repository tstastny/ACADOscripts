...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << (intg_V+sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00))));
    acadodata_f1 << theta;
    acadodata_f1 << phi;
    acadodata_f1 << asin(1/sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00)))*v);
    acadodata_f1 << p;
    acadodata_f1 << q;
    acadodata_f1 << r;
    acadodata_f1 << (Cw2*x_w2_uT+Dw2*uT);
    acadodata_f1 << (Cw2*x_w2_uE+Dw2*uE);
    acadodata_f1 << (Cw2*x_w2_uA+Dw2*uA);
    acadodata_f1 << (Cw2*x_w2_uR+Dw2*uR);
    acadodata_f1 << (Cw2*x_w2_sv+Dw2*sv);
    Function acadodata_f2;
    acadodata_f2 << (intg_V+sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00))));
    acadodata_f2 << theta;
    acadodata_f2 << phi;
    acadodata_f2 << asin(1/sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00)))*v);
    acadodata_f2 << p;
    acadodata_f2 << q;
    acadodata_f2 << r;
    OCP ocp1(0, 0.5, 10);
    ...
    ocp1.setDimensions( 0, 15, 0, 0, 0, 5, 5, 0 );
