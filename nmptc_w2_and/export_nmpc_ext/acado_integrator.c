...
acadoWorkspace.rk_xxx[13] = rk_eta[208];
acadoWorkspace.rk_xxx[14] = rk_eta[209];
acadoWorkspace.rk_xxx[15] = rk_eta[210];
acadoWorkspace.rk_xxx[16] = rk_eta[211];
acadoWorkspace.rk_xxx[17] = rk_eta[212];
acadoWorkspace.rk_xxx[18] = rk_eta[213];
acadoWorkspace.rk_xxx[19] = rk_eta[214];
acadoWorkspace.rk_xxx[20] = rk_eta[215];
acadoWorkspace.rk_xxx[21] = rk_eta[216];
acadoWorkspace.rk_xxx[22] = rk_eta[217];
acadoWorkspace.rk_xxx[23] = rk_eta[218];
acadoWorkspace.rk_xxx[24] = rk_eta[219];
acadoWorkspace.rk_xxx[25] = rk_eta[220];
acadoWorkspace.rk_xxx[26] = rk_eta[221];
acadoWorkspace.rk_xxx[27] = rk_eta[222];
acadoWorkspace.rk_xxx[28] = rk_eta[223];
acadoWorkspace.rk_xxx[29] = rk_eta[224];
acadoWorkspace.rk_xxx[30] = rk_eta[225];
acadoWorkspace.rk_xxx[31] = rk_eta[226];
acadoWorkspace.rk_xxx[32] = rk_eta[227];
acadoWorkspace.rk_xxx[33] = rk_eta[228];
acadoWorkspace.rk_xxx[34] = rk_eta[229];
acadoWorkspace.rk_xxx[35] = rk_eta[230];
acadoWorkspace.rk_xxx[36] = rk_eta[231];
acadoWorkspace.rk_xxx[37] = rk_eta[232];
acadoWorkspace.rk_xxx[38] = rk_eta[233];
acadoWorkspace.rk_xxx[39] = rk_eta[234];
acadoWorkspace.rk_xxx[40] = rk_eta[235];
acadoWorkspace.rk_xxx[41] = rk_eta[236];
acadoWorkspace.rk_xxx[42] = rk_eta[237];
acadoWorkspace.rk_xxx[43] = rk_eta[238];
acadoWorkspace.rk_xxx[44] = rk_eta[239];
...
rhs_jac( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 195 ]) );
for (j = 0; j < 13; ++j)
{
tmp_index1 = (run1 * 13) + (j);
acadoWorkspace.rk_A[tmp_index1 * 26] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 1] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 2] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 3] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 4] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 5] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 6] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 7] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 8] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 9] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 10] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 11] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 12] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 12)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 26) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 26 + 13] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 14] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 15] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 16] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 17] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 18] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 19] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 20] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 21] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 22] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 23] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 24] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 25] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 195) + (j * 15 + 12)];
...
for (i = 0; i < 2; ++i)
{
acadoWorkspace.rk_b[i * 13] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1)];
acadoWorkspace.rk_b[i * 13 + 1] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 15)];
acadoWorkspace.rk_b[i * 13 + 2] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 30)];
acadoWorkspace.rk_b[i * 13 + 3] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 45)];
acadoWorkspace.rk_b[i * 13 + 4] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 60)];
acadoWorkspace.rk_b[i * 13 + 5] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 75)];
acadoWorkspace.rk_b[i * 13 + 6] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 90)];
acadoWorkspace.rk_b[i * 13 + 7] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 105)];
acadoWorkspace.rk_b[i * 13 + 8] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 120)];
acadoWorkspace.rk_b[i * 13 + 9] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 135)];
acadoWorkspace.rk_b[i * 13 + 10] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 150)];
acadoWorkspace.rk_b[i * 13 + 11] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 165)];
acadoWorkspace.rk_b[i * 13 + 12] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (run1 + 180)];
}
if( 0 == run1 ) {
det = solve_dim26_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim26_perm );
}
...
acadoWorkspace.rk_b[tmp_index1] = - acadoWorkspace.rk_diffsTemp2[(i * 195) + (tmp_index2 + 13)];
}
}
solve_dim26_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim26_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 13; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 15) + (run1 + 13)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
{
tmp_index2 = (j) + (i * 13);
rk_eta[tmp_index2 + 13] = acadoWorkspace.rk_diffsNew2[(i * 15) + (j)];
}
for (j = 0; j < 2; ++j)
{
tmp_index2 = (j) + (i * 2);
rk_eta[tmp_index2 + 182] = acadoWorkspace.rk_diffsNew2[(i * 15) + (j + 13)];
}
}
resetIntegrator = 0;
