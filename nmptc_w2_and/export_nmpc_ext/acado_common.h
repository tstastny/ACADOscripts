...
/** Matrix of size: 31 x 30 (row major format)
 * 
...
/** Matrix of size: 2 x 195 (row major format) */
real_t rk_diffsTemp2[ 390 ];

/** Matrix of size: 13 x 2 (row major format) */
real_t rk_diffK[ 26 ];

/** Matrix of size: 13 x 15 (row major format) */
real_t rk_diffsNew2[ 195 ];
...
/** Matrix of size: 390 x 2 (row major format) */
real_t evGu[ 780 ];
...
/** Matrix of size: 390 x 14 (row major format) */
real_t Q2[ 5460 ];

/** Matrix of size: 60 x 2 (row major format) */
real_t R1[ 120 ];

/** Matrix of size: 60 x 14 (row major format) */
real_t R2[ 840 ];
...
/** Matrix of size: 13 x 14 (row major format) */
real_t QN2[ 182 ];
...
/** Matrix of size: 6045 x 2 (row major format) */
real_t E[ 12090 ];
