...
int main()
{
    ...
    double xx[13] = {375.672710879851,55.8887584206519,3.60007187861490,13.4985667821690,1.65829179068265e-16,1.61271066417902e-10,-1.86859017145711e-10,0.0129489649910787,1.57990401606663e-10,-2.08024055693348e-15,-1.41806644796166e-10,0.366950640910386,0};
	for (i = 0; i < (N + 1); ++i)
        for (j = 0; j < NX; ++j) acadoVariables.x[ NX * i + j ] = xx[ j ];
    
    double uu[3] = {0.366950640910384,-8.77904949335322e-11,0.0213916291461479};
	for (i = 0; i < N; ++i)
    ...
    /* online data */
    double odod[26] = {0,0,500,0,0,1.57079632679490,0,0,0,500,0,0,1.57079632679490,0,30,0.800000000000000,0,0,0,0.139626340159546,-0.0523598775598299,0.0349065850398866,5,0.500000000000000,3.50000000000000,1.50000000000000};
	for (i = 0; i < (N+1); ++i)
