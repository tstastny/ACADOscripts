...
{
real_t rk_dim40_swap;

/** Column vector of size: 40 */
real_t rk_dim40_bPerm[ 40 ];
...
int rk_dim40_perm[ 40 ];

/** Column vector of size: 20 */
real_t rk_rhsTemp[ 20 ];

/** Matrix of size: 2 x 500 (row major format) */
real_t rk_diffsTemp2[ 1000 ];

/** Matrix of size: 20 x 2 (row major format) */
real_t rk_diffK[ 40 ];

/** Matrix of size: 20 x 25 (row major format) */
real_t rk_diffsNew2[ 500 ];

/** Row vector of size: 546 */
real_t state[ 546 ];
...
/** Row vector of size: 312 */
real_t objValueOut[ 312 ];
...
/** Matrix of size: 4200 x 5 (row major format) */
real_t E[ 21000 ];
...
/** Matrix of size: 100 x 20 (row major format) */
real_t H10[ 2000 ];
 ...
 *
 *  \param rk_eta Working array of size 46 to pass the input values and return the results.
