...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    OnlineData we; 
    OnlineData wd; 
    OnlineData mu_dot_prev; 
    OnlineData gamma_dot_prev; 
    ...
    ocp1.subjectTo((-1.745329E+00) <= mu_dot <= 1.745329E+00);
    ocp1.subjectTo((-1.745329E+00) <= gamma_dot <= 1.745329E+00);
    ocp1.setNOD( 24 );
    ocp1.setNP( 0 );
    ocp1.setNU( 2 );
    ocp1.setModel( "model", "rhs", "rhs_jac" );
    ocp1.setDimensions( 0, 9, 0, 0, 0, 2, 24, 0 );
