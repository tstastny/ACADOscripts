...
/** Matrix of size: 31 x 24 (row major format)
 * 
...
/** Matrix of size: 2 x 99 (row major format) */
real_t rk_diffsTemp2[ 198 ];

/** Matrix of size: 9 x 2 (row major format) */
real_t rk_diffK[ 18 ];

/** Matrix of size: 9 x 11 (row major format) */
real_t rk_diffsNew2[ 99 ];

/** Row vector of size: 134 */
real_t state[ 134 ];
