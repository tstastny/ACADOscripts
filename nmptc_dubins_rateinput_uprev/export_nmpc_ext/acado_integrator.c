...
void solve_dim18_triangular( real_t* const A, real_t* const b )
{
...
real_t solve_dim18_system( real_t* const A, real_t* const b, int* const rk_perm )
{
real_t det;
...
det *= A[323];
det = fabs(det);
solve_dim18_triangular( A, b );
return det;
}

void solve_dim18_system_reuse( real_t* const A, real_t* const b, int* const rk_perm )
{
...
solve_dim18_triangular( A, acadoWorkspace.rk_dim18_bPerm );
...
acadoWorkspace.rk_xxx[9] = rk_eta[108];
acadoWorkspace.rk_xxx[10] = rk_eta[109];
acadoWorkspace.rk_xxx[11] = rk_eta[110];
...
rhs_jac( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 99 ]) );
for (j = 0; j < 9; ++j)
{
tmp_index1 = (run1 * 9) + (j);
acadoWorkspace.rk_A[tmp_index1 * 18] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 1] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 2] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 3] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 4] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 5] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 6] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 7] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 8] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 8)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 18) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 18 + 9] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 10] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 11] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 12] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 13] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 14] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 15] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 16] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 18 + 17] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 99) + (j * 11 + 8)];
...
det = solve_dim18_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim18_perm );
for (j = 0; j < 2; ++j)
{
...
solve_dim18_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim18_perm );
for (j = 0; j < 2; ++j)
{
acadoWorkspace.rk_kkk[j] += acadoWorkspace.rk_b[j * 9];
acadoWorkspace.rk_kkk[j + 2] += acadoWorkspace.rk_b[j * 9 + 1];
...
for (i = 0; i < 2; ++i)
{
acadoWorkspace.rk_b[i * 9] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1)];
acadoWorkspace.rk_b[i * 9 + 1] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 11)];
acadoWorkspace.rk_b[i * 9 + 2] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 22)];
acadoWorkspace.rk_b[i * 9 + 3] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 33)];
acadoWorkspace.rk_b[i * 9 + 4] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 44)];
acadoWorkspace.rk_b[i * 9 + 5] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 55)];
acadoWorkspace.rk_b[i * 9 + 6] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 66)];
acadoWorkspace.rk_b[i * 9 + 7] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 77)];
acadoWorkspace.rk_b[i * 9 + 8] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (run1 + 88)];
}
if( 0 == run1 ) {
det = solve_dim18_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim18_perm );
}
...
acadoWorkspace.rk_diffsNew2[(i * 11) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
acadoWorkspace.rk_b[tmp_index1] = - acadoWorkspace.rk_diffsTemp2[(i * 99) + (tmp_index2 + 9)];
}
}
solve_dim18_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim18_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 9; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 11) + (run1 + 9)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
{
tmp_index2 = (j) + (i * 9);
rk_eta[tmp_index2 + 9] = acadoWorkspace.rk_diffsNew2[(i * 11) + (j)];
}
for (j = 0; j < 2; ++j)
{
tmp_index2 = (j) + (i * 2);
rk_eta[tmp_index2 + 90] = acadoWorkspace.rk_diffsNew2[(i * 11) + (j + 9)];
}
}
resetIntegrator = 0;
