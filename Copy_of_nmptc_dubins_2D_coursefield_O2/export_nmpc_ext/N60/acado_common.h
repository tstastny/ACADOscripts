...
{
int dummy;
/** Matrix of size: 61 x 8 (row major format)
 * 
...
/** Matrix of size: 61 x 23 (row major format)
 * 
 ...
 * 
 *  Matrix containing 60 reference/measurement vectors of size 8 for first 60 nodes.
 */
real_t y[ 480 ];
