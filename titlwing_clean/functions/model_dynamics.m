...
% state differentials
d_states(1) = 1/m*(T*cos(zeta_w)-m*g*sin(theta)-k_T2L*T*sin(zeta_w)...
...
d_states(2) =1/m*(-T*sin(zeta_w)+m*g*cos(theta)-k_T2L*T*cos(zeta_w)...
...
d_states(5) = (T_ref - T)/tau_T; % Trust dynamics  
