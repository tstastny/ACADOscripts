...
acadoWorkspace.rk_xxx[26] = rk_eta[260];
acadoWorkspace.rk_xxx[27] = rk_eta[261];
acadoWorkspace.rk_xxx[28] = rk_eta[262];
acadoWorkspace.rk_xxx[29] = rk_eta[263];
acadoWorkspace.rk_xxx[30] = rk_eta[264];
acadoWorkspace.rk_xxx[31] = rk_eta[265];
acadoWorkspace.rk_xxx[32] = rk_eta[266];
acadoWorkspace.rk_xxx[33] = rk_eta[267];
acadoWorkspace.rk_xxx[34] = rk_eta[268];
acadoWorkspace.rk_xxx[35] = rk_eta[269];
acadoWorkspace.rk_xxx[36] = rk_eta[270];
acadoWorkspace.rk_xxx[37] = rk_eta[271];
acadoWorkspace.rk_xxx[38] = rk_eta[272];
acadoWorkspace.rk_xxx[39] = rk_eta[273];
acadoWorkspace.rk_xxx[40] = rk_eta[274];
acadoWorkspace.rk_xxx[41] = rk_eta[275];
acadoWorkspace.rk_xxx[42] = rk_eta[276];
acadoWorkspace.rk_xxx[43] = rk_eta[277];
acadoWorkspace.rk_xxx[44] = rk_eta[278];
...
rhs_jac( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 234 ]) );
for (j = 0; j < 13; ++j)
{
tmp_index1 = (run1 * 13) + (j);
acadoWorkspace.rk_A[tmp_index1 * 26] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 1] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 2] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 3] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 4] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 5] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 6] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 7] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 8] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 9] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 10] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 11] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 12] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 12)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 26) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 26 + 13] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 14] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 15] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 16] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 17] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 18] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 19] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 20] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 21] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 22] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 23] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 24] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 25] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 234) + (j * 18 + 12)];
...
for (i = 0; i < 13; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 18) + (run1 + 13)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
