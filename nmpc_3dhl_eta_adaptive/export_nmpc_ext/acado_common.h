...
/** Matrix of size: 41 x 27 (row major format)
 * 
...
/** Matrix of size: 520 x 5 (row major format) */
real_t evGu[ 2600 ];

/** Row vector of size: 45 */
real_t objValueIn[ 45 ];

/** Row vector of size: 304 */
real_t objValueOut[ 304 ];
...
/** Matrix of size: 10660 x 5 (row major format) */
real_t E[ 53300 ];
