...
acadoWorkspace.state[56] = acadoVariables.od[lRun1 * 9];
acadoWorkspace.state[57] = acadoVariables.od[lRun1 * 9 + 1];
acadoWorkspace.state[58] = acadoVariables.od[lRun1 * 9 + 2];
acadoWorkspace.state[59] = acadoVariables.od[lRun1 * 9 + 3];
acadoWorkspace.state[60] = acadoVariables.od[lRun1 * 9 + 4];
acadoWorkspace.state[61] = acadoVariables.od[lRun1 * 9 + 5];
acadoWorkspace.state[62] = acadoVariables.od[lRun1 * 9 + 6];
acadoWorkspace.state[63] = acadoVariables.od[lRun1 * 9 + 7];
acadoWorkspace.state[64] = acadoVariables.od[lRun1 * 9 + 8];
...
{
tmpR2[0] = + tmpFu[0]*tmpObjS[0] + tmpFu[2]*tmpObjS[6] + tmpFu[4]*tmpObjS[12] + tmpFu[6]*tmpObjS[18] + tmpFu[8]*tmpObjS[24] + tmpFu[10]*tmpObjS[30];
tmpR2[1] = + tmpFu[0]*tmpObjS[1] + tmpFu[2]*tmpObjS[7] + tmpFu[4]*tmpObjS[13] + tmpFu[6]*tmpObjS[19] + tmpFu[8]*tmpObjS[25] + tmpFu[10]*tmpObjS[31];
tmpR2[2] = + tmpFu[0]*tmpObjS[2] + tmpFu[2]*tmpObjS[8] + tmpFu[4]*tmpObjS[14] + tmpFu[6]*tmpObjS[20] + tmpFu[8]*tmpObjS[26] + tmpFu[10]*tmpObjS[32];
tmpR2[3] = + tmpFu[0]*tmpObjS[3] + tmpFu[2]*tmpObjS[9] + tmpFu[4]*tmpObjS[15] + tmpFu[6]*tmpObjS[21] + tmpFu[8]*tmpObjS[27] + tmpFu[10]*tmpObjS[33];
tmpR2[4] = + tmpFu[0]*tmpObjS[4] + tmpFu[2]*tmpObjS[10] + tmpFu[4]*tmpObjS[16] + tmpFu[6]*tmpObjS[22] + tmpFu[8]*tmpObjS[28] + tmpFu[10]*tmpObjS[34];
tmpR2[5] = + tmpFu[0]*tmpObjS[5] + tmpFu[2]*tmpObjS[11] + tmpFu[4]*tmpObjS[17] + tmpFu[6]*tmpObjS[23] + tmpFu[8]*tmpObjS[29] + tmpFu[10]*tmpObjS[35];
tmpR2[6] = + tmpFu[1]*tmpObjS[0] + tmpFu[3]*tmpObjS[6] + tmpFu[5]*tmpObjS[12] + tmpFu[7]*tmpObjS[18] + tmpFu[9]*tmpObjS[24] + tmpFu[11]*tmpObjS[30];
tmpR2[7] = + tmpFu[1]*tmpObjS[1] + tmpFu[3]*tmpObjS[7] + tmpFu[5]*tmpObjS[13] + tmpFu[7]*tmpObjS[19] + tmpFu[9]*tmpObjS[25] + tmpFu[11]*tmpObjS[31];
tmpR2[8] = + tmpFu[1]*tmpObjS[2] + tmpFu[3]*tmpObjS[8] + tmpFu[5]*tmpObjS[14] + tmpFu[7]*tmpObjS[20] + tmpFu[9]*tmpObjS[26] + tmpFu[11]*tmpObjS[32];
tmpR2[9] = + tmpFu[1]*tmpObjS[3] + tmpFu[3]*tmpObjS[9] + tmpFu[5]*tmpObjS[15] + tmpFu[7]*tmpObjS[21] + tmpFu[9]*tmpObjS[27] + tmpFu[11]*tmpObjS[33];
tmpR2[10] = + tmpFu[1]*tmpObjS[4] + tmpFu[3]*tmpObjS[10] + tmpFu[5]*tmpObjS[16] + tmpFu[7]*tmpObjS[22] + tmpFu[9]*tmpObjS[28] + tmpFu[11]*tmpObjS[34];
tmpR2[11] = + tmpFu[1]*tmpObjS[5] + tmpFu[3]*tmpObjS[11] + tmpFu[5]*tmpObjS[17] + tmpFu[7]*tmpObjS[23] + tmpFu[9]*tmpObjS[29] + tmpFu[11]*tmpObjS[35];
tmpR1[0] = + tmpR2[0]*tmpFu[0] + tmpR2[1]*tmpFu[2] + tmpR2[2]*tmpFu[4] + tmpR2[3]*tmpFu[6] + tmpR2[4]*tmpFu[8] + tmpR2[5]*tmpFu[10];
tmpR1[1] = + tmpR2[0]*tmpFu[1] + tmpR2[1]*tmpFu[3] + tmpR2[2]*tmpFu[5] + tmpR2[3]*tmpFu[7] + tmpR2[4]*tmpFu[9] + tmpR2[5]*tmpFu[11];
tmpR1[2] = + tmpR2[6]*tmpFu[0] + tmpR2[7]*tmpFu[2] + tmpR2[8]*tmpFu[4] + tmpR2[9]*tmpFu[6] + tmpR2[10]*tmpFu[8] + tmpR2[11]*tmpFu[10];
tmpR1[3] = + tmpR2[6]*tmpFu[1] + tmpR2[7]*tmpFu[3] + tmpR2[8]*tmpFu[5] + tmpR2[9]*tmpFu[7] + tmpR2[10]*tmpFu[9] + tmpR2[11]*tmpFu[11];
}
...
acadoWorkspace.objValueIn[8] = acadoVariables.od[runObj * 9];
acadoWorkspace.objValueIn[9] = acadoVariables.od[runObj * 9 + 1];
acadoWorkspace.objValueIn[10] = acadoVariables.od[runObj * 9 + 2];
acadoWorkspace.objValueIn[11] = acadoVariables.od[runObj * 9 + 3];
acadoWorkspace.objValueIn[12] = acadoVariables.od[runObj * 9 + 4];
acadoWorkspace.objValueIn[13] = acadoVariables.od[runObj * 9 + 5];
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 9 + 6];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 9 + 7];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 9 + 8];
...
acado_setObjR1R2( &(acadoWorkspace.objValueOut[ 42 ]), &(acadoVariables.W[ runObj * 36 ]), &(acadoWorkspace.R1[ runObj * 4 ]), &(acadoWorkspace.R2[ runObj * 12 ]) );
...
acadoWorkspace.objValueIn[6] = acadoVariables.od[900];
acadoWorkspace.objValueIn[7] = acadoVariables.od[901];
acadoWorkspace.objValueIn[8] = acadoVariables.od[902];
acadoWorkspace.objValueIn[9] = acadoVariables.od[903];
acadoWorkspace.objValueIn[10] = acadoVariables.od[904];
acadoWorkspace.objValueIn[11] = acadoVariables.od[905];
acadoWorkspace.objValueIn[12] = acadoVariables.od[906];
acadoWorkspace.objValueIn[13] = acadoVariables.od[907];
acadoWorkspace.objValueIn[14] = acadoVariables.od[908];
...
acadoWorkspace.conValueIn[8] = acadoVariables.od[lRun1 * 9];
acadoWorkspace.conValueIn[9] = acadoVariables.od[lRun1 * 9 + 1];
acadoWorkspace.conValueIn[10] = acadoVariables.od[lRun1 * 9 + 2];
acadoWorkspace.conValueIn[11] = acadoVariables.od[lRun1 * 9 + 3];
acadoWorkspace.conValueIn[12] = acadoVariables.od[lRun1 * 9 + 4];
acadoWorkspace.conValueIn[13] = acadoVariables.od[lRun1 * 9 + 5];
acadoWorkspace.conValueIn[14] = acadoVariables.od[lRun1 * 9 + 6];
acadoWorkspace.conValueIn[15] = acadoVariables.od[lRun1 * 9 + 7];
acadoWorkspace.conValueIn[16] = acadoVariables.od[lRun1 * 9 + 8];
...
acadoWorkspace.lbA[30] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[30];
acadoWorkspace.lbA[31] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[31];
...
acadoWorkspace.lbA[34] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[34];
...
acadoWorkspace.lbA[39] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[39];
...
acadoWorkspace.lbA[42] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[42];
acadoWorkspace.lbA[43] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[43];
...
acadoWorkspace.lbA[46] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[46];
...
acadoWorkspace.lbA[51] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[51];
...
acadoWorkspace.lbA[54] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[54];
acadoWorkspace.lbA[55] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[55];
...
acadoWorkspace.lbA[58] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[58];
...
acadoWorkspace.lbA[62] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[62];
acadoWorkspace.lbA[63] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[63];
...
acadoWorkspace.lbA[66] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[66];
acadoWorkspace.lbA[67] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[67];
...
acadoWorkspace.lbA[70] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[70];
acadoWorkspace.lbA[71] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[71];
...
acadoWorkspace.lbA[74] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[74];
acadoWorkspace.lbA[75] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[75];
...
acadoWorkspace.lbA[78] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[78];
acadoWorkspace.lbA[79] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[79];
acadoWorkspace.lbA[80] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[80];
acadoWorkspace.lbA[81] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[81];
acadoWorkspace.lbA[82] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[82];
acadoWorkspace.lbA[83] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[83];
acadoWorkspace.lbA[84] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[84];
acadoWorkspace.lbA[85] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[85];
acadoWorkspace.lbA[86] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[86];
acadoWorkspace.lbA[87] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[87];
acadoWorkspace.lbA[88] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[88];
acadoWorkspace.lbA[89] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[89];
acadoWorkspace.lbA[90] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[90];
acadoWorkspace.lbA[91] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[91];
acadoWorkspace.lbA[92] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[92];
acadoWorkspace.lbA[93] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[93];
acadoWorkspace.lbA[94] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[94];
acadoWorkspace.lbA[95] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[95];
acadoWorkspace.lbA[96] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[96];
acadoWorkspace.lbA[97] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[97];
acadoWorkspace.lbA[98] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[98];
acadoWorkspace.lbA[99] = (real_t)-2.0000000000000000e+00 - acadoWorkspace.evH[99];

acadoWorkspace.ubA[0] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[0];
acadoWorkspace.ubA[1] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[1];
acadoWorkspace.ubA[2] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[2];
acadoWorkspace.ubA[3] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[3];
acadoWorkspace.ubA[4] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[4];
acadoWorkspace.ubA[5] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[5];
acadoWorkspace.ubA[6] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[6];
acadoWorkspace.ubA[7] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[7];
acadoWorkspace.ubA[8] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[8];
acadoWorkspace.ubA[9] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[9];
acadoWorkspace.ubA[10] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[10];
acadoWorkspace.ubA[11] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[11];
acadoWorkspace.ubA[12] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[12];
acadoWorkspace.ubA[13] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[13];
acadoWorkspace.ubA[14] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[14];
acadoWorkspace.ubA[15] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[15];
acadoWorkspace.ubA[16] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[16];
acadoWorkspace.ubA[17] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[17];
acadoWorkspace.ubA[18] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[18];
acadoWorkspace.ubA[19] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[19];
acadoWorkspace.ubA[20] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[20];
acadoWorkspace.ubA[21] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[21];
acadoWorkspace.ubA[22] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[22];
acadoWorkspace.ubA[23] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[23];
acadoWorkspace.ubA[24] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[24];
acadoWorkspace.ubA[25] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[25];
acadoWorkspace.ubA[26] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[26];
acadoWorkspace.ubA[27] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[27];
acadoWorkspace.ubA[28] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[28];
acadoWorkspace.ubA[29] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[29];
acadoWorkspace.ubA[30] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[30];
acadoWorkspace.ubA[31] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[31];
acadoWorkspace.ubA[32] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[32];
acadoWorkspace.ubA[33] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[33];
acadoWorkspace.ubA[34] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[34];
acadoWorkspace.ubA[35] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[35];
acadoWorkspace.ubA[36] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[36];
acadoWorkspace.ubA[37] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[37];
acadoWorkspace.ubA[38] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[38];
acadoWorkspace.ubA[39] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[39];
acadoWorkspace.ubA[40] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[40];
acadoWorkspace.ubA[41] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[41];
acadoWorkspace.ubA[42] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[42];
acadoWorkspace.ubA[43] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[43];
acadoWorkspace.ubA[44] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[44];
acadoWorkspace.ubA[45] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[45];
acadoWorkspace.ubA[46] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[46];
acadoWorkspace.ubA[47] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[47];
acadoWorkspace.ubA[48] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[48];
acadoWorkspace.ubA[49] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[49];
acadoWorkspace.ubA[50] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[50];
acadoWorkspace.ubA[51] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[51];
acadoWorkspace.ubA[52] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[52];
acadoWorkspace.ubA[53] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[53];
acadoWorkspace.ubA[54] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[54];
acadoWorkspace.ubA[55] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[55];
acadoWorkspace.ubA[56] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[56];
acadoWorkspace.ubA[57] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[57];
acadoWorkspace.ubA[58] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[58];
acadoWorkspace.ubA[59] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[59];
acadoWorkspace.ubA[60] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[60];
acadoWorkspace.ubA[61] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[61];
acadoWorkspace.ubA[62] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[62];
acadoWorkspace.ubA[63] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[63];
acadoWorkspace.ubA[64] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[64];
acadoWorkspace.ubA[65] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[65];
acadoWorkspace.ubA[66] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[66];
acadoWorkspace.ubA[67] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[67];
acadoWorkspace.ubA[68] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[68];
acadoWorkspace.ubA[69] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[69];
acadoWorkspace.ubA[70] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[70];
acadoWorkspace.ubA[71] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[71];
acadoWorkspace.ubA[72] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[72];
acadoWorkspace.ubA[73] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[73];
acadoWorkspace.ubA[74] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[74];
acadoWorkspace.ubA[75] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[75];
acadoWorkspace.ubA[76] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[76];
acadoWorkspace.ubA[77] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[77];
acadoWorkspace.ubA[78] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[78];
acadoWorkspace.ubA[79] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[79];
acadoWorkspace.ubA[80] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[80];
acadoWorkspace.ubA[81] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[81];
acadoWorkspace.ubA[82] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[82];
acadoWorkspace.ubA[83] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[83];
acadoWorkspace.ubA[84] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[84];
acadoWorkspace.ubA[85] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[85];
acadoWorkspace.ubA[86] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[86];
acadoWorkspace.ubA[87] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[87];
acadoWorkspace.ubA[88] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[88];
acadoWorkspace.ubA[89] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[89];
acadoWorkspace.ubA[90] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[90];
acadoWorkspace.ubA[91] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[91];
acadoWorkspace.ubA[92] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[92];
acadoWorkspace.ubA[93] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[93];
acadoWorkspace.ubA[94] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[94];
acadoWorkspace.ubA[95] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[95];
acadoWorkspace.ubA[96] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[96];
acadoWorkspace.ubA[97] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[97];
acadoWorkspace.ubA[98] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[98];
acadoWorkspace.ubA[99] = (real_t)4.0000000000000000e+00 - acadoWorkspace.evH[99];
...
acadoWorkspace.state[56] = acadoVariables.od[index * 9];
acadoWorkspace.state[57] = acadoVariables.od[index * 9 + 1];
acadoWorkspace.state[58] = acadoVariables.od[index * 9 + 2];
acadoWorkspace.state[59] = acadoVariables.od[index * 9 + 3];
acadoWorkspace.state[60] = acadoVariables.od[index * 9 + 4];
acadoWorkspace.state[61] = acadoVariables.od[index * 9 + 5];
acadoWorkspace.state[62] = acadoVariables.od[index * 9 + 6];
acadoWorkspace.state[63] = acadoVariables.od[index * 9 + 7];
acadoWorkspace.state[64] = acadoVariables.od[index * 9 + 8];
...
acadoWorkspace.state[56] = acadoVariables.od[900];
acadoWorkspace.state[57] = acadoVariables.od[901];
acadoWorkspace.state[58] = acadoVariables.od[902];
acadoWorkspace.state[59] = acadoVariables.od[903];
acadoWorkspace.state[60] = acadoVariables.od[904];
acadoWorkspace.state[61] = acadoVariables.od[905];
acadoWorkspace.state[62] = acadoVariables.od[906];
acadoWorkspace.state[63] = acadoVariables.od[907];
acadoWorkspace.state[64] = acadoVariables.od[908];
...
acadoWorkspace.objValueIn[8] = acadoVariables.od[lRun1 * 9];
acadoWorkspace.objValueIn[9] = acadoVariables.od[lRun1 * 9 + 1];
acadoWorkspace.objValueIn[10] = acadoVariables.od[lRun1 * 9 + 2];
acadoWorkspace.objValueIn[11] = acadoVariables.od[lRun1 * 9 + 3];
acadoWorkspace.objValueIn[12] = acadoVariables.od[lRun1 * 9 + 4];
acadoWorkspace.objValueIn[13] = acadoVariables.od[lRun1 * 9 + 5];
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 9 + 6];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 9 + 7];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 9 + 8];
