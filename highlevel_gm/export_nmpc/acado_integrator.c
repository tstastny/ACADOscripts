...
out[19] = (((real_t)(0.0000000000000000e+00)-od[0])*a[8]);
...
out[27] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
...
out[35] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(9.8100000000000005e+00)*a[9])*a[12]))*a[13])*a[14]);
out[36] = (real_t)(0.0000000000000000e+00);
out[37] = ((((real_t)(9.8100000000000005e+00)/a[10])*a[15])*a[14]);
...
out[45] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[16]);
...
for (i = 0; i < 6; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1 + 6)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
