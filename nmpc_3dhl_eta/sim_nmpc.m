...
R_scale     = [1, 1 30*pi/180 15*pi/180, 1 30*pi/180 15*pi/180];

Q_output    = [150 100, 10, 20 20 5, 1]./Q_scale.^2;
QN_output   = [150 100, 10, 20 20 5, 1]./Q_scale.^2;
R_controls  = [40 0 0 0 0 0 0]./R_scale.^2;
