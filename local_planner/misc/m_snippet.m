castray(*d_occ, double *p_occ, double *p1, double *p2, double *p3, 
r0[3], const r1[3], const double v[3], 
pos_n_origin, const pos_e_origin, const double terr_dis, double *terr_map) { 
...
x0 = (r0[0] - pos_e_origin)/terr_dis; 
y0 = (r0[1] - pos_n_origin)/terr_dis; 
...
n = int(floor(x1)-x + floor(y1)-y) + 1; 
 
% initialize stepping criteria 
t_next_horizontal, t_last_horizontal; 
t_next_vertical, t_last_vertical; 
x_inc, y_inc; 
...
% for loop init 
x_check, y_check, x_check1, y_check1, idx_corner1, idx_corner2, idx_corner3, idx_corner4, ret; 
t, h_exit, h_check; 
