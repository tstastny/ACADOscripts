...
const double delta_r, const double gamma, const double k_delta_r, const double k_r_offset, const double log_sqrt_w_over_sig1_r, const double p1_h, const double p2_h, const double p3_h, const double r_occ, const double r_offset, const double terr_dis, const double v, const double v_ray_e, const double v_ray_h, const double v_ray_n, const double v_rel, const double v_rel_sq, const double xi) {
...
jac[3] = k_r_offset*log_sqrt_w_over_sig1_r*t3*t18*v_rel*2.0-k_delta_r*log_sqrt_w_over_sig1_r*t18*t19*t24*v_rel*2.0; 
jac[4] = k_r_offset*log_sqrt_w_over_sig1_r*t3*t22*v_rel*-2.0+k_delta_r*log_sqrt_w_over_sig1_r*t19*t22*t24*v_rel*2.0; 
jac[5] = k_r_offset*log_sqrt_w_over_sig1_r*t3*t26*v_rel*2.0-k_delta_r*log_sqrt_w_over_sig1_r*t19*t24*t26*v_rel*2.0; 
