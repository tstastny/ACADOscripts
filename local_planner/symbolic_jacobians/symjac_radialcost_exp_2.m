...
r_offset_1_expr = r_offset + vG_sq_expr*k_r;
...
jac_sig_r_tl_exp = subs(jac_sig_r_tl_exp , r_offset + vG_sq*k_r, r_offset_1);
jac_sig_r_br_exp = subs(jac_sig_r_br_exp , r_offset + vG_sq*k_r, r_offset_1);
...
jac_sig_r_tl_lin = subs(jac_sig_r_tl_lin , r_offset + vG_sq*k_r, r_offset_1);
jac_sig_r_br_lin = subs(jac_sig_r_br_lin , r_offset + vG_sq*k_r, r_offset_1);
