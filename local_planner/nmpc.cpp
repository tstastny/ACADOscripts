...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(v) == ((-(((-8.98999999999999938050e-02)*delta_flaps+5.07639999999999980140e-01*pow(delta_flaps,2.00000000000000000000e+00))*2.00000000000000000000e+00+(-gamma+theta)*3.47380000000000022098e-01+2.59919999999999984386e-01*pow((-gamma+theta),2.00000000000000000000e+00)+6.03139999999999995572e-02)*4.17999999999999982681e-01*5.00000000000000000000e-01*pow(v,2.00000000000000000000e+00)*rho+((-1.32619999999999987894e-01)/2.80000000000000026645e-01*cos((-3.49065850398865909487e-02-gamma+theta))/n_p*v+1.15210000000000006848e-01)*6.14656000000000229955e-03*cos((-gamma+theta))*pow(n_p,2.00000000000000000000e+00)*rho)*3.20102432778489098819e-01-9.81000000000000049738e+00*sin(gamma));
    acadodata_f1 << dot(gamma) == ((((-1.32619999999999987894e-01)/2.80000000000000026645e-01*cos((-3.49065850398865909487e-02-gamma+theta))/n_p*v+1.15210000000000006848e-01)*6.14656000000000229955e-03*pow(n_p,2.00000000000000000000e+00)*rho*sin((-gamma+theta))+((-2.03799999999999981171e+00)*delta_flaps+(-gamma+theta)*2.85009999999999985576e+00+5.21549999999999958078e-01)*4.17999999999999982681e-01*5.00000000000000000000e-01*pow(v,2.00000000000000000000e+00)*rho)*cos(phi)-3.06464400000000019020e+01*cos(gamma))*3.20102432778489098819e-01/v;
