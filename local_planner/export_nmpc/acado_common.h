...
/** Matrix of size: 41 x 3283 (row major format)
 * 
...
/** Matrix of size: 480 x 12 (row major format) */
real_t W[ 5760 ];
 ...
 *
 *  \param rk_eta Working array of size 3295 to pass the input values and return the results.
