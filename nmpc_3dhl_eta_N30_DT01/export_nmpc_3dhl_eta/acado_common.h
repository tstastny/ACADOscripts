...
/** Matrix of size: 31 x 28 (row major format)
 * 
...
/** Matrix of size: 390 x 3 (row major format) */
real_t evGu[ 1170 ];
...
/** Matrix of size: 90 x 11 (row major format) */
real_t R2[ 990 ];
...
/** Matrix of size: 6045 x 3 (row major format) */
real_t E[ 18135 ];
...
/** Matrix of size: 90 x 13 (row major format) */
real_t H10[ 1170 ];
