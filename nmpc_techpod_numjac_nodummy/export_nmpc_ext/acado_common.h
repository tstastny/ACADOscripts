...
/** Matrix of size: 2 x 266 (row major format) */
real_t rk_diffsTemp2[ 532 ];

/** Matrix of size: 14 x 2 (row major format) */
real_t rk_diffK[ 28 ];

/** Matrix of size: 14 x 19 (row major format) */
real_t rk_diffsNew2[ 266 ];

/** Row vector of size: 290 */
real_t state[ 290 ];
...
/** Matrix of size: 140 x 5 (row major format) */
real_t evGu[ 700 ];
...
/** Matrix of size: 140 x 12 (row major format) */
real_t Q2[ 1680 ];
...
/** Matrix of size: 14 x 7 (row major format) */
real_t QN2[ 98 ];
...
/** Matrix of size: 770 x 5 (row major format) */
real_t E[ 3850 ];
