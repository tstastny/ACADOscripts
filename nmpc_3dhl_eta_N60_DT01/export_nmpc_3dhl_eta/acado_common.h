...
/** Matrix of size: 61 x 28 (row major format)
 * 
 ...
 * 
 *  Matrix containing 60 reference/measurement vectors of size 11 for first 60 nodes.
 */
real_t y[ 660 ];
...
/** Matrix of size: 660 x 11 (row major format) */
real_t W[ 7260 ];
...
/** Matrix of size: 780 x 13 (row major format) */
real_t evGx[ 10140 ];

/** Matrix of size: 780 x 3 (row major format) */
real_t evGu[ 2340 ];
...
/** Matrix of size: 780 x 11 (row major format) */
real_t Q2[ 8580 ];
...
/** Matrix of size: 23790 x 3 (row major format) */
real_t E[ 71370 ];
...
/** Column vector of size: 793 */
real_t QDy[ 793 ];

/** Matrix of size: 180 x 13 (row major format) */
real_t H10[ 2340 ];
