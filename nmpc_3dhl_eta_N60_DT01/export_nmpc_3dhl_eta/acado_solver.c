...
acadoWorkspace.objValueIn[0] = acadoVariables.x[780];
acadoWorkspace.objValueIn[1] = acadoVariables.x[781];
acadoWorkspace.objValueIn[2] = acadoVariables.x[782];
acadoWorkspace.objValueIn[3] = acadoVariables.x[783];
acadoWorkspace.objValueIn[4] = acadoVariables.x[784];
acadoWorkspace.objValueIn[5] = acadoVariables.x[785];
acadoWorkspace.objValueIn[6] = acadoVariables.x[786];
acadoWorkspace.objValueIn[7] = acadoVariables.x[787];
acadoWorkspace.objValueIn[8] = acadoVariables.x[788];
acadoWorkspace.objValueIn[9] = acadoVariables.x[789];
acadoWorkspace.objValueIn[10] = acadoVariables.x[790];
acadoWorkspace.objValueIn[11] = acadoVariables.x[791];
acadoWorkspace.objValueIn[12] = acadoVariables.x[792];
...
acadoWorkspace.objValueIn[37] = acadoVariables.od[1704];
acadoWorkspace.objValueIn[38] = acadoVariables.od[1705];
acadoWorkspace.objValueIn[39] = acadoVariables.od[1706];
acadoWorkspace.objValueIn[40] = acadoVariables.od[1707];
...
{
acadoWorkspace.H[(iRow * 540) + (iCol * 3)] += + Gu1[0]*Gu2[0] + Gu1[3]*Gu2[3] + Gu1[6]*Gu2[6] + Gu1[9]*Gu2[9] + Gu1[12]*Gu2[12] + Gu1[15]*Gu2[15] + Gu1[18]*Gu2[18] + Gu1[21]*Gu2[21] + Gu1[24]*Gu2[24] + Gu1[27]*Gu2[27] + Gu1[30]*Gu2[30] + Gu1[33]*Gu2[33] + Gu1[36]*Gu2[36];
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 1)] += + Gu1[0]*Gu2[1] + Gu1[3]*Gu2[4] + Gu1[6]*Gu2[7] + Gu1[9]*Gu2[10] + Gu1[12]*Gu2[13] + Gu1[15]*Gu2[16] + Gu1[18]*Gu2[19] + Gu1[21]*Gu2[22] + Gu1[24]*Gu2[25] + Gu1[27]*Gu2[28] + Gu1[30]*Gu2[31] + Gu1[33]*Gu2[34] + Gu1[36]*Gu2[37];
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 2)] += + Gu1[0]*Gu2[2] + Gu1[3]*Gu2[5] + Gu1[6]*Gu2[8] + Gu1[9]*Gu2[11] + Gu1[12]*Gu2[14] + Gu1[15]*Gu2[17] + Gu1[18]*Gu2[20] + Gu1[21]*Gu2[23] + Gu1[24]*Gu2[26] + Gu1[27]*Gu2[29] + Gu1[30]*Gu2[32] + Gu1[33]*Gu2[35] + Gu1[36]*Gu2[38];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3)] += + Gu1[1]*Gu2[0] + Gu1[4]*Gu2[3] + Gu1[7]*Gu2[6] + Gu1[10]*Gu2[9] + Gu1[13]*Gu2[12] + Gu1[16]*Gu2[15] + Gu1[19]*Gu2[18] + Gu1[22]*Gu2[21] + Gu1[25]*Gu2[24] + Gu1[28]*Gu2[27] + Gu1[31]*Gu2[30] + Gu1[34]*Gu2[33] + Gu1[37]*Gu2[36];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 1)] += + Gu1[1]*Gu2[1] + Gu1[4]*Gu2[4] + Gu1[7]*Gu2[7] + Gu1[10]*Gu2[10] + Gu1[13]*Gu2[13] + Gu1[16]*Gu2[16] + Gu1[19]*Gu2[19] + Gu1[22]*Gu2[22] + Gu1[25]*Gu2[25] + Gu1[28]*Gu2[28] + Gu1[31]*Gu2[31] + Gu1[34]*Gu2[34] + Gu1[37]*Gu2[37];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 2)] += + Gu1[1]*Gu2[2] + Gu1[4]*Gu2[5] + Gu1[7]*Gu2[8] + Gu1[10]*Gu2[11] + Gu1[13]*Gu2[14] + Gu1[16]*Gu2[17] + Gu1[19]*Gu2[20] + Gu1[22]*Gu2[23] + Gu1[25]*Gu2[26] + Gu1[28]*Gu2[29] + Gu1[31]*Gu2[32] + Gu1[34]*Gu2[35] + Gu1[37]*Gu2[38];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3)] += + Gu1[2]*Gu2[0] + Gu1[5]*Gu2[3] + Gu1[8]*Gu2[6] + Gu1[11]*Gu2[9] + Gu1[14]*Gu2[12] + Gu1[17]*Gu2[15] + Gu1[20]*Gu2[18] + Gu1[23]*Gu2[21] + Gu1[26]*Gu2[24] + Gu1[29]*Gu2[27] + Gu1[32]*Gu2[30] + Gu1[35]*Gu2[33] + Gu1[38]*Gu2[36];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 1)] += + Gu1[2]*Gu2[1] + Gu1[5]*Gu2[4] + Gu1[8]*Gu2[7] + Gu1[11]*Gu2[10] + Gu1[14]*Gu2[13] + Gu1[17]*Gu2[16] + Gu1[20]*Gu2[19] + Gu1[23]*Gu2[22] + Gu1[26]*Gu2[25] + Gu1[29]*Gu2[28] + Gu1[32]*Gu2[31] + Gu1[35]*Gu2[34] + Gu1[38]*Gu2[37];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 2)] += + Gu1[2]*Gu2[2] + Gu1[5]*Gu2[5] + Gu1[8]*Gu2[8] + Gu1[11]*Gu2[11] + Gu1[14]*Gu2[14] + Gu1[17]*Gu2[17] + Gu1[20]*Gu2[20] + Gu1[23]*Gu2[23] + Gu1[26]*Gu2[26] + Gu1[29]*Gu2[29] + Gu1[32]*Gu2[32] + Gu1[35]*Gu2[35] + Gu1[38]*Gu2[38];
}

void setBlockH11_R1( int iRow, int iCol, real_t* const R11 )
{
acadoWorkspace.H[(iRow * 540) + (iCol * 3)] = R11[0] + (real_t)1.0000000000000000e-10;
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 1)] = R11[1];
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 2)] = R11[2];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3)] = R11[3];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 1)] = R11[4] + (real_t)1.0000000000000000e-10;
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 2)] = R11[5];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3)] = R11[6];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 1)] = R11[7];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 2)] = R11[8] + (real_t)1.0000000000000000e-10;
}

void zeroBlockH11( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 540) + (iCol * 3)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 1)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 2)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 1)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 2)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 1)] = 0.0000000000000000e+00;
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 2)] = 0.0000000000000000e+00;
}

void copyHTH( int iRow, int iCol )
{
acadoWorkspace.H[(iRow * 540) + (iCol * 3)] = acadoWorkspace.H[(iCol * 540) + (iRow * 3)];
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 1)] = acadoWorkspace.H[(iCol * 540 + 180) + (iRow * 3)];
acadoWorkspace.H[(iRow * 540) + (iCol * 3 + 2)] = acadoWorkspace.H[(iCol * 540 + 360) + (iRow * 3)];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3)] = acadoWorkspace.H[(iCol * 540) + (iRow * 3 + 1)];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 1)] = acadoWorkspace.H[(iCol * 540 + 180) + (iRow * 3 + 1)];
acadoWorkspace.H[(iRow * 540 + 180) + (iCol * 3 + 2)] = acadoWorkspace.H[(iCol * 540 + 360) + (iRow * 3 + 1)];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3)] = acadoWorkspace.H[(iCol * 540) + (iRow * 3 + 2)];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 1)] = acadoWorkspace.H[(iCol * 540 + 180) + (iRow * 3 + 2)];
acadoWorkspace.H[(iRow * 540 + 360) + (iCol * 3 + 2)] = acadoWorkspace.H[(iCol * 540 + 360) + (iRow * 3 + 2)];
}
...
multQN1d( acadoWorkspace.QN1, &(acadoWorkspace.d[ 767 ]), &(acadoWorkspace.Qd[ 767 ]) );
...
acadoWorkspace.QDy[780] = + acadoWorkspace.QN2[0]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[1]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[2]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[3]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[4]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[5]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[6]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[781] = + acadoWorkspace.QN2[7]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[8]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[9]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[10]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[11]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[12]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[13]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[782] = + acadoWorkspace.QN2[14]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[15]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[16]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[17]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[18]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[19]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[20]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[783] = + acadoWorkspace.QN2[21]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[22]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[23]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[24]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[25]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[26]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[27]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[784] = + acadoWorkspace.QN2[28]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[29]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[30]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[31]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[32]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[33]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[34]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[785] = + acadoWorkspace.QN2[35]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[36]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[37]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[38]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[39]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[40]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[41]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[786] = + acadoWorkspace.QN2[42]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[43]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[44]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[45]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[46]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[47]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[48]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[787] = + acadoWorkspace.QN2[49]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[50]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[51]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[52]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[53]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[54]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[55]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[788] = + acadoWorkspace.QN2[56]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[57]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[58]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[59]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[60]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[61]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[62]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[789] = + acadoWorkspace.QN2[63]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[64]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[65]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[66]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[67]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[68]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[69]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[790] = + acadoWorkspace.QN2[70]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[71]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[72]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[73]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[74]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[75]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[76]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[791] = + acadoWorkspace.QN2[77]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[78]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[79]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[80]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[81]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[82]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[83]*acadoWorkspace.DyN[6];
acadoWorkspace.QDy[792] = + acadoWorkspace.QN2[84]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[85]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[86]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[87]*acadoWorkspace.DyN[3] + acadoWorkspace.QN2[88]*acadoWorkspace.DyN[4] + acadoWorkspace.QN2[89]*acadoWorkspace.DyN[5] + acadoWorkspace.QN2[90]*acadoWorkspace.DyN[6];

for (lRun2 = 0; lRun2 < 780; ++lRun2)
...
{
acadoVariables.x[780] = xEnd[0];
acadoVariables.x[781] = xEnd[1];
acadoVariables.x[782] = xEnd[2];
acadoVariables.x[783] = xEnd[3];
acadoVariables.x[784] = xEnd[4];
acadoVariables.x[785] = xEnd[5];
acadoVariables.x[786] = xEnd[6];
acadoVariables.x[787] = xEnd[7];
acadoVariables.x[788] = xEnd[8];
acadoVariables.x[789] = xEnd[9];
acadoVariables.x[790] = xEnd[10];
acadoVariables.x[791] = xEnd[11];
acadoVariables.x[792] = xEnd[12];
}
else if (strategy == 2) 
{
acadoWorkspace.state[0] = acadoVariables.x[780];
acadoWorkspace.state[1] = acadoVariables.x[781];
acadoWorkspace.state[2] = acadoVariables.x[782];
acadoWorkspace.state[3] = acadoVariables.x[783];
acadoWorkspace.state[4] = acadoVariables.x[784];
acadoWorkspace.state[5] = acadoVariables.x[785];
acadoWorkspace.state[6] = acadoVariables.x[786];
acadoWorkspace.state[7] = acadoVariables.x[787];
acadoWorkspace.state[8] = acadoVariables.x[788];
acadoWorkspace.state[9] = acadoVariables.x[789];
acadoWorkspace.state[10] = acadoVariables.x[790];
acadoWorkspace.state[11] = acadoVariables.x[791];
acadoWorkspace.state[12] = acadoVariables.x[792];
if (uEnd != 0)
{
...
{
acadoWorkspace.state[221] = acadoVariables.u[177];
acadoWorkspace.state[222] = acadoVariables.u[178];
acadoWorkspace.state[223] = acadoVariables.u[179];
}
...
acadoWorkspace.state[248] = acadoVariables.od[1704];
acadoWorkspace.state[249] = acadoVariables.od[1705];
acadoWorkspace.state[250] = acadoVariables.od[1706];
acadoWorkspace.state[251] = acadoVariables.od[1707];

integrate(acadoWorkspace.state, 1);

acadoVariables.x[780] = acadoWorkspace.state[0];
acadoVariables.x[781] = acadoWorkspace.state[1];
acadoVariables.x[782] = acadoWorkspace.state[2];
acadoVariables.x[783] = acadoWorkspace.state[3];
acadoVariables.x[784] = acadoWorkspace.state[4];
acadoVariables.x[785] = acadoWorkspace.state[5];
acadoVariables.x[786] = acadoWorkspace.state[6];
acadoVariables.x[787] = acadoWorkspace.state[7];
acadoVariables.x[788] = acadoWorkspace.state[8];
acadoVariables.x[789] = acadoWorkspace.state[9];
acadoVariables.x[790] = acadoWorkspace.state[10];
acadoVariables.x[791] = acadoWorkspace.state[11];
acadoVariables.x[792] = acadoWorkspace.state[12];
}
}
...
if (uEnd != 0)
{
acadoVariables.u[177] = uEnd[0];
acadoVariables.u[178] = uEnd[1];
acadoVariables.u[179] = uEnd[2];
}
}
