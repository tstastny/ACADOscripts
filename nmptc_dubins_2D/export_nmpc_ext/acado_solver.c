...
acadoWorkspace.state[49] = acadoVariables.od[lRun1 * 22];
acadoWorkspace.state[50] = acadoVariables.od[lRun1 * 22 + 1];
acadoWorkspace.state[51] = acadoVariables.od[lRun1 * 22 + 2];
acadoWorkspace.state[52] = acadoVariables.od[lRun1 * 22 + 3];
acadoWorkspace.state[53] = acadoVariables.od[lRun1 * 22 + 4];
acadoWorkspace.state[54] = acadoVariables.od[lRun1 * 22 + 5];
acadoWorkspace.state[55] = acadoVariables.od[lRun1 * 22 + 6];
acadoWorkspace.state[56] = acadoVariables.od[lRun1 * 22 + 7];
acadoWorkspace.state[57] = acadoVariables.od[lRun1 * 22 + 8];
acadoWorkspace.state[58] = acadoVariables.od[lRun1 * 22 + 9];
acadoWorkspace.state[59] = acadoVariables.od[lRun1 * 22 + 10];
acadoWorkspace.state[60] = acadoVariables.od[lRun1 * 22 + 11];
acadoWorkspace.state[61] = acadoVariables.od[lRun1 * 22 + 12];
acadoWorkspace.state[62] = acadoVariables.od[lRun1 * 22 + 13];
acadoWorkspace.state[63] = acadoVariables.od[lRun1 * 22 + 14];
acadoWorkspace.state[64] = acadoVariables.od[lRun1 * 22 + 15];
acadoWorkspace.state[65] = acadoVariables.od[lRun1 * 22 + 16];
acadoWorkspace.state[66] = acadoVariables.od[lRun1 * 22 + 17];
acadoWorkspace.state[67] = acadoVariables.od[lRun1 * 22 + 18];
acadoWorkspace.state[68] = acadoVariables.od[lRun1 * 22 + 19];
acadoWorkspace.state[69] = acadoVariables.od[lRun1 * 22 + 20];
acadoWorkspace.state[70] = acadoVariables.od[lRun1 * 22 + 21];
...
acadoWorkspace.objValueIn[7] = acadoVariables.od[runObj * 22];
acadoWorkspace.objValueIn[8] = acadoVariables.od[runObj * 22 + 1];
acadoWorkspace.objValueIn[9] = acadoVariables.od[runObj * 22 + 2];
acadoWorkspace.objValueIn[10] = acadoVariables.od[runObj * 22 + 3];
acadoWorkspace.objValueIn[11] = acadoVariables.od[runObj * 22 + 4];
acadoWorkspace.objValueIn[12] = acadoVariables.od[runObj * 22 + 5];
acadoWorkspace.objValueIn[13] = acadoVariables.od[runObj * 22 + 6];
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 22 + 7];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 22 + 8];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 22 + 9];
acadoWorkspace.objValueIn[17] = acadoVariables.od[runObj * 22 + 10];
acadoWorkspace.objValueIn[18] = acadoVariables.od[runObj * 22 + 11];
acadoWorkspace.objValueIn[19] = acadoVariables.od[runObj * 22 + 12];
acadoWorkspace.objValueIn[20] = acadoVariables.od[runObj * 22 + 13];
acadoWorkspace.objValueIn[21] = acadoVariables.od[runObj * 22 + 14];
acadoWorkspace.objValueIn[22] = acadoVariables.od[runObj * 22 + 15];
acadoWorkspace.objValueIn[23] = acadoVariables.od[runObj * 22 + 16];
acadoWorkspace.objValueIn[24] = acadoVariables.od[runObj * 22 + 17];
acadoWorkspace.objValueIn[25] = acadoVariables.od[runObj * 22 + 18];
acadoWorkspace.objValueIn[26] = acadoVariables.od[runObj * 22 + 19];
acadoWorkspace.objValueIn[27] = acadoVariables.od[runObj * 22 + 20];
acadoWorkspace.objValueIn[28] = acadoVariables.od[runObj * 22 + 21];
...
acadoWorkspace.state[49] = acadoVariables.od[index * 22];
acadoWorkspace.state[50] = acadoVariables.od[index * 22 + 1];
acadoWorkspace.state[51] = acadoVariables.od[index * 22 + 2];
acadoWorkspace.state[52] = acadoVariables.od[index * 22 + 3];
acadoWorkspace.state[53] = acadoVariables.od[index * 22 + 4];
acadoWorkspace.state[54] = acadoVariables.od[index * 22 + 5];
acadoWorkspace.state[55] = acadoVariables.od[index * 22 + 6];
acadoWorkspace.state[56] = acadoVariables.od[index * 22 + 7];
acadoWorkspace.state[57] = acadoVariables.od[index * 22 + 8];
acadoWorkspace.state[58] = acadoVariables.od[index * 22 + 9];
acadoWorkspace.state[59] = acadoVariables.od[index * 22 + 10];
acadoWorkspace.state[60] = acadoVariables.od[index * 22 + 11];
acadoWorkspace.state[61] = acadoVariables.od[index * 22 + 12];
acadoWorkspace.state[62] = acadoVariables.od[index * 22 + 13];
acadoWorkspace.state[63] = acadoVariables.od[index * 22 + 14];
acadoWorkspace.state[64] = acadoVariables.od[index * 22 + 15];
acadoWorkspace.state[65] = acadoVariables.od[index * 22 + 16];
acadoWorkspace.state[66] = acadoVariables.od[index * 22 + 17];
acadoWorkspace.state[67] = acadoVariables.od[index * 22 + 18];
acadoWorkspace.state[68] = acadoVariables.od[index * 22 + 19];
acadoWorkspace.state[69] = acadoVariables.od[index * 22 + 20];
acadoWorkspace.state[70] = acadoVariables.od[index * 22 + 21];
...
acadoWorkspace.state[49] = acadoVariables.od[660];
acadoWorkspace.state[50] = acadoVariables.od[661];
acadoWorkspace.state[51] = acadoVariables.od[662];
acadoWorkspace.state[52] = acadoVariables.od[663];
acadoWorkspace.state[53] = acadoVariables.od[664];
acadoWorkspace.state[54] = acadoVariables.od[665];
acadoWorkspace.state[55] = acadoVariables.od[666];
acadoWorkspace.state[56] = acadoVariables.od[667];
acadoWorkspace.state[57] = acadoVariables.od[668];
acadoWorkspace.state[58] = acadoVariables.od[669];
acadoWorkspace.state[59] = acadoVariables.od[670];
acadoWorkspace.state[60] = acadoVariables.od[671];
acadoWorkspace.state[61] = acadoVariables.od[672];
acadoWorkspace.state[62] = acadoVariables.od[673];
acadoWorkspace.state[63] = acadoVariables.od[674];
acadoWorkspace.state[64] = acadoVariables.od[675];
acadoWorkspace.state[65] = acadoVariables.od[676];
acadoWorkspace.state[66] = acadoVariables.od[677];
acadoWorkspace.state[67] = acadoVariables.od[678];
acadoWorkspace.state[68] = acadoVariables.od[679];
acadoWorkspace.state[69] = acadoVariables.od[680];
acadoWorkspace.state[70] = acadoVariables.od[681];
...
acadoWorkspace.objValueIn[7] = acadoVariables.od[lRun1 * 22];
acadoWorkspace.objValueIn[8] = acadoVariables.od[lRun1 * 22 + 1];
acadoWorkspace.objValueIn[9] = acadoVariables.od[lRun1 * 22 + 2];
acadoWorkspace.objValueIn[10] = acadoVariables.od[lRun1 * 22 + 3];
acadoWorkspace.objValueIn[11] = acadoVariables.od[lRun1 * 22 + 4];
acadoWorkspace.objValueIn[12] = acadoVariables.od[lRun1 * 22 + 5];
acadoWorkspace.objValueIn[13] = acadoVariables.od[lRun1 * 22 + 6];
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 22 + 7];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 22 + 8];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 22 + 9];
acadoWorkspace.objValueIn[17] = acadoVariables.od[lRun1 * 22 + 10];
acadoWorkspace.objValueIn[18] = acadoVariables.od[lRun1 * 22 + 11];
acadoWorkspace.objValueIn[19] = acadoVariables.od[lRun1 * 22 + 12];
acadoWorkspace.objValueIn[20] = acadoVariables.od[lRun1 * 22 + 13];
acadoWorkspace.objValueIn[21] = acadoVariables.od[lRun1 * 22 + 14];
acadoWorkspace.objValueIn[22] = acadoVariables.od[lRun1 * 22 + 15];
acadoWorkspace.objValueIn[23] = acadoVariables.od[lRun1 * 22 + 16];
acadoWorkspace.objValueIn[24] = acadoVariables.od[lRun1 * 22 + 17];
acadoWorkspace.objValueIn[25] = acadoVariables.od[lRun1 * 22 + 18];
acadoWorkspace.objValueIn[26] = acadoVariables.od[lRun1 * 22 + 19];
acadoWorkspace.objValueIn[27] = acadoVariables.od[lRun1 * 22 + 20];
acadoWorkspace.objValueIn[28] = acadoVariables.od[lRun1 * 22 + 21];
...
acadoWorkspace.objValueIn[4] = acadoVariables.x[184];
acadoWorkspace.objValueIn[5] = acadoVariables.x[185];
acadoWorkspace.objValueIn[6] = acadoVariables.od[660];
acadoWorkspace.objValueIn[7] = acadoVariables.od[661];
acadoWorkspace.objValueIn[8] = acadoVariables.od[662];
acadoWorkspace.objValueIn[9] = acadoVariables.od[663];
acadoWorkspace.objValueIn[10] = acadoVariables.od[664];
acadoWorkspace.objValueIn[11] = acadoVariables.od[665];
acadoWorkspace.objValueIn[12] = acadoVariables.od[666];
acadoWorkspace.objValueIn[13] = acadoVariables.od[667];
acadoWorkspace.objValueIn[14] = acadoVariables.od[668];
acadoWorkspace.objValueIn[15] = acadoVariables.od[669];
acadoWorkspace.objValueIn[16] = acadoVariables.od[670];
acadoWorkspace.objValueIn[17] = acadoVariables.od[671];
acadoWorkspace.objValueIn[18] = acadoVariables.od[672];
acadoWorkspace.objValueIn[19] = acadoVariables.od[673];
acadoWorkspace.objValueIn[20] = acadoVariables.od[674];
acadoWorkspace.objValueIn[21] = acadoVariables.od[675];
acadoWorkspace.objValueIn[22] = acadoVariables.od[676];
acadoWorkspace.objValueIn[23] = acadoVariables.od[677];
acadoWorkspace.objValueIn[24] = acadoVariables.od[678];
acadoWorkspace.objValueIn[25] = acadoVariables.od[679];
acadoWorkspace.objValueIn[26] = acadoVariables.od[680];
acadoWorkspace.objValueIn[27] = acadoVariables.od[681];
evaluateLSQEndTerm( acadoWorkspace.objValueIn, acadoWorkspace.objValueOut );
