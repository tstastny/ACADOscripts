...
acadoWorkspace.state[36] = acadoVariables.od[lRun1 * 22];
acadoWorkspace.state[37] = acadoVariables.od[lRun1 * 22 + 1];
acadoWorkspace.state[38] = acadoVariables.od[lRun1 * 22 + 2];
acadoWorkspace.state[39] = acadoVariables.od[lRun1 * 22 + 3];
acadoWorkspace.state[40] = acadoVariables.od[lRun1 * 22 + 4];
acadoWorkspace.state[41] = acadoVariables.od[lRun1 * 22 + 5];
acadoWorkspace.state[42] = acadoVariables.od[lRun1 * 22 + 6];
acadoWorkspace.state[43] = acadoVariables.od[lRun1 * 22 + 7];
acadoWorkspace.state[44] = acadoVariables.od[lRun1 * 22 + 8];
acadoWorkspace.state[45] = acadoVariables.od[lRun1 * 22 + 9];
acadoWorkspace.state[46] = acadoVariables.od[lRun1 * 22 + 10];
acadoWorkspace.state[47] = acadoVariables.od[lRun1 * 22 + 11];
acadoWorkspace.state[48] = acadoVariables.od[lRun1 * 22 + 12];
acadoWorkspace.state[49] = acadoVariables.od[lRun1 * 22 + 13];
acadoWorkspace.state[50] = acadoVariables.od[lRun1 * 22 + 14];
acadoWorkspace.state[51] = acadoVariables.od[lRun1 * 22 + 15];
acadoWorkspace.state[52] = acadoVariables.od[lRun1 * 22 + 16];
acadoWorkspace.state[53] = acadoVariables.od[lRun1 * 22 + 17];
acadoWorkspace.state[54] = acadoVariables.od[lRun1 * 22 + 18];
acadoWorkspace.state[55] = acadoVariables.od[lRun1 * 22 + 19];
acadoWorkspace.state[56] = acadoVariables.od[lRun1 * 22 + 20];
acadoWorkspace.state[57] = acadoVariables.od[lRun1 * 22 + 21];
...
{
tmpQ2[0] = + tmpFx[0]*tmpObjS[0] + tmpFx[5]*tmpObjS[6] + tmpFx[10]*tmpObjS[12] + tmpFx[15]*tmpObjS[18] + tmpFx[20]*tmpObjS[24] + tmpFx[25]*tmpObjS[30];
tmpQ2[1] = + tmpFx[0]*tmpObjS[1] + tmpFx[5]*tmpObjS[7] + tmpFx[10]*tmpObjS[13] + tmpFx[15]*tmpObjS[19] + tmpFx[20]*tmpObjS[25] + tmpFx[25]*tmpObjS[31];
tmpQ2[2] = + tmpFx[0]*tmpObjS[2] + tmpFx[5]*tmpObjS[8] + tmpFx[10]*tmpObjS[14] + tmpFx[15]*tmpObjS[20] + tmpFx[20]*tmpObjS[26] + tmpFx[25]*tmpObjS[32];
tmpQ2[3] = + tmpFx[0]*tmpObjS[3] + tmpFx[5]*tmpObjS[9] + tmpFx[10]*tmpObjS[15] + tmpFx[15]*tmpObjS[21] + tmpFx[20]*tmpObjS[27] + tmpFx[25]*tmpObjS[33];
tmpQ2[4] = + tmpFx[0]*tmpObjS[4] + tmpFx[5]*tmpObjS[10] + tmpFx[10]*tmpObjS[16] + tmpFx[15]*tmpObjS[22] + tmpFx[20]*tmpObjS[28] + tmpFx[25]*tmpObjS[34];
tmpQ2[5] = + tmpFx[0]*tmpObjS[5] + tmpFx[5]*tmpObjS[11] + tmpFx[10]*tmpObjS[17] + tmpFx[15]*tmpObjS[23] + tmpFx[20]*tmpObjS[29] + tmpFx[25]*tmpObjS[35];
tmpQ2[6] = + tmpFx[1]*tmpObjS[0] + tmpFx[6]*tmpObjS[6] + tmpFx[11]*tmpObjS[12] + tmpFx[16]*tmpObjS[18] + tmpFx[21]*tmpObjS[24] + tmpFx[26]*tmpObjS[30];
tmpQ2[7] = + tmpFx[1]*tmpObjS[1] + tmpFx[6]*tmpObjS[7] + tmpFx[11]*tmpObjS[13] + tmpFx[16]*tmpObjS[19] + tmpFx[21]*tmpObjS[25] + tmpFx[26]*tmpObjS[31];
tmpQ2[8] = + tmpFx[1]*tmpObjS[2] + tmpFx[6]*tmpObjS[8] + tmpFx[11]*tmpObjS[14] + tmpFx[16]*tmpObjS[20] + tmpFx[21]*tmpObjS[26] + tmpFx[26]*tmpObjS[32];
tmpQ2[9] = + tmpFx[1]*tmpObjS[3] + tmpFx[6]*tmpObjS[9] + tmpFx[11]*tmpObjS[15] + tmpFx[16]*tmpObjS[21] + tmpFx[21]*tmpObjS[27] + tmpFx[26]*tmpObjS[33];
tmpQ2[10] = + tmpFx[1]*tmpObjS[4] + tmpFx[6]*tmpObjS[10] + tmpFx[11]*tmpObjS[16] + tmpFx[16]*tmpObjS[22] + tmpFx[21]*tmpObjS[28] + tmpFx[26]*tmpObjS[34];
tmpQ2[11] = + tmpFx[1]*tmpObjS[5] + tmpFx[6]*tmpObjS[11] + tmpFx[11]*tmpObjS[17] + tmpFx[16]*tmpObjS[23] + tmpFx[21]*tmpObjS[29] + tmpFx[26]*tmpObjS[35];
tmpQ2[12] = + tmpFx[2]*tmpObjS[0] + tmpFx[7]*tmpObjS[6] + tmpFx[12]*tmpObjS[12] + tmpFx[17]*tmpObjS[18] + tmpFx[22]*tmpObjS[24] + tmpFx[27]*tmpObjS[30];
tmpQ2[13] = + tmpFx[2]*tmpObjS[1] + tmpFx[7]*tmpObjS[7] + tmpFx[12]*tmpObjS[13] + tmpFx[17]*tmpObjS[19] + tmpFx[22]*tmpObjS[25] + tmpFx[27]*tmpObjS[31];
tmpQ2[14] = + tmpFx[2]*tmpObjS[2] + tmpFx[7]*tmpObjS[8] + tmpFx[12]*tmpObjS[14] + tmpFx[17]*tmpObjS[20] + tmpFx[22]*tmpObjS[26] + tmpFx[27]*tmpObjS[32];
tmpQ2[15] = + tmpFx[2]*tmpObjS[3] + tmpFx[7]*tmpObjS[9] + tmpFx[12]*tmpObjS[15] + tmpFx[17]*tmpObjS[21] + tmpFx[22]*tmpObjS[27] + tmpFx[27]*tmpObjS[33];
tmpQ2[16] = + tmpFx[2]*tmpObjS[4] + tmpFx[7]*tmpObjS[10] + tmpFx[12]*tmpObjS[16] + tmpFx[17]*tmpObjS[22] + tmpFx[22]*tmpObjS[28] + tmpFx[27]*tmpObjS[34];
tmpQ2[17] = + tmpFx[2]*tmpObjS[5] + tmpFx[7]*tmpObjS[11] + tmpFx[12]*tmpObjS[17] + tmpFx[17]*tmpObjS[23] + tmpFx[22]*tmpObjS[29] + tmpFx[27]*tmpObjS[35];
tmpQ2[18] = + tmpFx[3]*tmpObjS[0] + tmpFx[8]*tmpObjS[6] + tmpFx[13]*tmpObjS[12] + tmpFx[18]*tmpObjS[18] + tmpFx[23]*tmpObjS[24] + tmpFx[28]*tmpObjS[30];
tmpQ2[19] = + tmpFx[3]*tmpObjS[1] + tmpFx[8]*tmpObjS[7] + tmpFx[13]*tmpObjS[13] + tmpFx[18]*tmpObjS[19] + tmpFx[23]*tmpObjS[25] + tmpFx[28]*tmpObjS[31];
tmpQ2[20] = + tmpFx[3]*tmpObjS[2] + tmpFx[8]*tmpObjS[8] + tmpFx[13]*tmpObjS[14] + tmpFx[18]*tmpObjS[20] + tmpFx[23]*tmpObjS[26] + tmpFx[28]*tmpObjS[32];
tmpQ2[21] = + tmpFx[3]*tmpObjS[3] + tmpFx[8]*tmpObjS[9] + tmpFx[13]*tmpObjS[15] + tmpFx[18]*tmpObjS[21] + tmpFx[23]*tmpObjS[27] + tmpFx[28]*tmpObjS[33];
tmpQ2[22] = + tmpFx[3]*tmpObjS[4] + tmpFx[8]*tmpObjS[10] + tmpFx[13]*tmpObjS[16] + tmpFx[18]*tmpObjS[22] + tmpFx[23]*tmpObjS[28] + tmpFx[28]*tmpObjS[34];
tmpQ2[23] = + tmpFx[3]*tmpObjS[5] + tmpFx[8]*tmpObjS[11] + tmpFx[13]*tmpObjS[17] + tmpFx[18]*tmpObjS[23] + tmpFx[23]*tmpObjS[29] + tmpFx[28]*tmpObjS[35];
tmpQ2[24] = + tmpFx[4]*tmpObjS[0] + tmpFx[9]*tmpObjS[6] + tmpFx[14]*tmpObjS[12] + tmpFx[19]*tmpObjS[18] + tmpFx[24]*tmpObjS[24] + tmpFx[29]*tmpObjS[30];
tmpQ2[25] = + tmpFx[4]*tmpObjS[1] + tmpFx[9]*tmpObjS[7] + tmpFx[14]*tmpObjS[13] + tmpFx[19]*tmpObjS[19] + tmpFx[24]*tmpObjS[25] + tmpFx[29]*tmpObjS[31];
tmpQ2[26] = + tmpFx[4]*tmpObjS[2] + tmpFx[9]*tmpObjS[8] + tmpFx[14]*tmpObjS[14] + tmpFx[19]*tmpObjS[20] + tmpFx[24]*tmpObjS[26] + tmpFx[29]*tmpObjS[32];
tmpQ2[27] = + tmpFx[4]*tmpObjS[3] + tmpFx[9]*tmpObjS[9] + tmpFx[14]*tmpObjS[15] + tmpFx[19]*tmpObjS[21] + tmpFx[24]*tmpObjS[27] + tmpFx[29]*tmpObjS[33];
tmpQ2[28] = + tmpFx[4]*tmpObjS[4] + tmpFx[9]*tmpObjS[10] + tmpFx[14]*tmpObjS[16] + tmpFx[19]*tmpObjS[22] + tmpFx[24]*tmpObjS[28] + tmpFx[29]*tmpObjS[34];
tmpQ2[29] = + tmpFx[4]*tmpObjS[5] + tmpFx[9]*tmpObjS[11] + tmpFx[14]*tmpObjS[17] + tmpFx[19]*tmpObjS[23] + tmpFx[24]*tmpObjS[29] + tmpFx[29]*tmpObjS[35];
tmpQ1[0] = + tmpQ2[0]*tmpFx[0] + tmpQ2[1]*tmpFx[5] + tmpQ2[2]*tmpFx[10] + tmpQ2[3]*tmpFx[15] + tmpQ2[4]*tmpFx[20] + tmpQ2[5]*tmpFx[25];
tmpQ1[1] = + tmpQ2[0]*tmpFx[1] + tmpQ2[1]*tmpFx[6] + tmpQ2[2]*tmpFx[11] + tmpQ2[3]*tmpFx[16] + tmpQ2[4]*tmpFx[21] + tmpQ2[5]*tmpFx[26];
tmpQ1[2] = + tmpQ2[0]*tmpFx[2] + tmpQ2[1]*tmpFx[7] + tmpQ2[2]*tmpFx[12] + tmpQ2[3]*tmpFx[17] + tmpQ2[4]*tmpFx[22] + tmpQ2[5]*tmpFx[27];
tmpQ1[3] = + tmpQ2[0]*tmpFx[3] + tmpQ2[1]*tmpFx[8] + tmpQ2[2]*tmpFx[13] + tmpQ2[3]*tmpFx[18] + tmpQ2[4]*tmpFx[23] + tmpQ2[5]*tmpFx[28];
tmpQ1[4] = + tmpQ2[0]*tmpFx[4] + tmpQ2[1]*tmpFx[9] + tmpQ2[2]*tmpFx[14] + tmpQ2[3]*tmpFx[19] + tmpQ2[4]*tmpFx[24] + tmpQ2[5]*tmpFx[29];
tmpQ1[5] = + tmpQ2[6]*tmpFx[0] + tmpQ2[7]*tmpFx[5] + tmpQ2[8]*tmpFx[10] + tmpQ2[9]*tmpFx[15] + tmpQ2[10]*tmpFx[20] + tmpQ2[11]*tmpFx[25];
tmpQ1[6] = + tmpQ2[6]*tmpFx[1] + tmpQ2[7]*tmpFx[6] + tmpQ2[8]*tmpFx[11] + tmpQ2[9]*tmpFx[16] + tmpQ2[10]*tmpFx[21] + tmpQ2[11]*tmpFx[26];
tmpQ1[7] = + tmpQ2[6]*tmpFx[2] + tmpQ2[7]*tmpFx[7] + tmpQ2[8]*tmpFx[12] + tmpQ2[9]*tmpFx[17] + tmpQ2[10]*tmpFx[22] + tmpQ2[11]*tmpFx[27];
tmpQ1[8] = + tmpQ2[6]*tmpFx[3] + tmpQ2[7]*tmpFx[8] + tmpQ2[8]*tmpFx[13] + tmpQ2[9]*tmpFx[18] + tmpQ2[10]*tmpFx[23] + tmpQ2[11]*tmpFx[28];
tmpQ1[9] = + tmpQ2[6]*tmpFx[4] + tmpQ2[7]*tmpFx[9] + tmpQ2[8]*tmpFx[14] + tmpQ2[9]*tmpFx[19] + tmpQ2[10]*tmpFx[24] + tmpQ2[11]*tmpFx[29];
tmpQ1[10] = + tmpQ2[12]*tmpFx[0] + tmpQ2[13]*tmpFx[5] + tmpQ2[14]*tmpFx[10] + tmpQ2[15]*tmpFx[15] + tmpQ2[16]*tmpFx[20] + tmpQ2[17]*tmpFx[25];
tmpQ1[11] = + tmpQ2[12]*tmpFx[1] + tmpQ2[13]*tmpFx[6] + tmpQ2[14]*tmpFx[11] + tmpQ2[15]*tmpFx[16] + tmpQ2[16]*tmpFx[21] + tmpQ2[17]*tmpFx[26];
tmpQ1[12] = + tmpQ2[12]*tmpFx[2] + tmpQ2[13]*tmpFx[7] + tmpQ2[14]*tmpFx[12] + tmpQ2[15]*tmpFx[17] + tmpQ2[16]*tmpFx[22] + tmpQ2[17]*tmpFx[27];
tmpQ1[13] = + tmpQ2[12]*tmpFx[3] + tmpQ2[13]*tmpFx[8] + tmpQ2[14]*tmpFx[13] + tmpQ2[15]*tmpFx[18] + tmpQ2[16]*tmpFx[23] + tmpQ2[17]*tmpFx[28];
tmpQ1[14] = + tmpQ2[12]*tmpFx[4] + tmpQ2[13]*tmpFx[9] + tmpQ2[14]*tmpFx[14] + tmpQ2[15]*tmpFx[19] + tmpQ2[16]*tmpFx[24] + tmpQ2[17]*tmpFx[29];
tmpQ1[15] = + tmpQ2[18]*tmpFx[0] + tmpQ2[19]*tmpFx[5] + tmpQ2[20]*tmpFx[10] + tmpQ2[21]*tmpFx[15] + tmpQ2[22]*tmpFx[20] + tmpQ2[23]*tmpFx[25];
tmpQ1[16] = + tmpQ2[18]*tmpFx[1] + tmpQ2[19]*tmpFx[6] + tmpQ2[20]*tmpFx[11] + tmpQ2[21]*tmpFx[16] + tmpQ2[22]*tmpFx[21] + tmpQ2[23]*tmpFx[26];
tmpQ1[17] = + tmpQ2[18]*tmpFx[2] + tmpQ2[19]*tmpFx[7] + tmpQ2[20]*tmpFx[12] + tmpQ2[21]*tmpFx[17] + tmpQ2[22]*tmpFx[22] + tmpQ2[23]*tmpFx[27];
tmpQ1[18] = + tmpQ2[18]*tmpFx[3] + tmpQ2[19]*tmpFx[8] + tmpQ2[20]*tmpFx[13] + tmpQ2[21]*tmpFx[18] + tmpQ2[22]*tmpFx[23] + tmpQ2[23]*tmpFx[28];
tmpQ1[19] = + tmpQ2[18]*tmpFx[4] + tmpQ2[19]*tmpFx[9] + tmpQ2[20]*tmpFx[14] + tmpQ2[21]*tmpFx[19] + tmpQ2[22]*tmpFx[24] + tmpQ2[23]*tmpFx[29];
tmpQ1[20] = + tmpQ2[24]*tmpFx[0] + tmpQ2[25]*tmpFx[5] + tmpQ2[26]*tmpFx[10] + tmpQ2[27]*tmpFx[15] + tmpQ2[28]*tmpFx[20] + tmpQ2[29]*tmpFx[25];
tmpQ1[21] = + tmpQ2[24]*tmpFx[1] + tmpQ2[25]*tmpFx[6] + tmpQ2[26]*tmpFx[11] + tmpQ2[27]*tmpFx[16] + tmpQ2[28]*tmpFx[21] + tmpQ2[29]*tmpFx[26];
tmpQ1[22] = + tmpQ2[24]*tmpFx[2] + tmpQ2[25]*tmpFx[7] + tmpQ2[26]*tmpFx[12] + tmpQ2[27]*tmpFx[17] + tmpQ2[28]*tmpFx[22] + tmpQ2[29]*tmpFx[27];
tmpQ1[23] = + tmpQ2[24]*tmpFx[3] + tmpQ2[25]*tmpFx[8] + tmpQ2[26]*tmpFx[13] + tmpQ2[27]*tmpFx[18] + tmpQ2[28]*tmpFx[23] + tmpQ2[29]*tmpFx[28];
tmpQ1[24] = + tmpQ2[24]*tmpFx[4] + tmpQ2[25]*tmpFx[9] + tmpQ2[26]*tmpFx[14] + tmpQ2[27]*tmpFx[19] + tmpQ2[28]*tmpFx[24] + tmpQ2[29]*tmpFx[29];
}
...
{
tmpQN2[0] = + tmpFx[0]*tmpObjSEndTerm[0] + tmpFx[5]*tmpObjSEndTerm[6] + tmpFx[10]*tmpObjSEndTerm[12] + tmpFx[15]*tmpObjSEndTerm[18] + tmpFx[20]*tmpObjSEndTerm[24] + tmpFx[25]*tmpObjSEndTerm[30];
tmpQN2[1] = + tmpFx[0]*tmpObjSEndTerm[1] + tmpFx[5]*tmpObjSEndTerm[7] + tmpFx[10]*tmpObjSEndTerm[13] + tmpFx[15]*tmpObjSEndTerm[19] + tmpFx[20]*tmpObjSEndTerm[25] + tmpFx[25]*tmpObjSEndTerm[31];
tmpQN2[2] = + tmpFx[0]*tmpObjSEndTerm[2] + tmpFx[5]*tmpObjSEndTerm[8] + tmpFx[10]*tmpObjSEndTerm[14] + tmpFx[15]*tmpObjSEndTerm[20] + tmpFx[20]*tmpObjSEndTerm[26] + tmpFx[25]*tmpObjSEndTerm[32];
tmpQN2[3] = + tmpFx[0]*tmpObjSEndTerm[3] + tmpFx[5]*tmpObjSEndTerm[9] + tmpFx[10]*tmpObjSEndTerm[15] + tmpFx[15]*tmpObjSEndTerm[21] + tmpFx[20]*tmpObjSEndTerm[27] + tmpFx[25]*tmpObjSEndTerm[33];
tmpQN2[4] = + tmpFx[0]*tmpObjSEndTerm[4] + tmpFx[5]*tmpObjSEndTerm[10] + tmpFx[10]*tmpObjSEndTerm[16] + tmpFx[15]*tmpObjSEndTerm[22] + tmpFx[20]*tmpObjSEndTerm[28] + tmpFx[25]*tmpObjSEndTerm[34];
tmpQN2[5] = + tmpFx[0]*tmpObjSEndTerm[5] + tmpFx[5]*tmpObjSEndTerm[11] + tmpFx[10]*tmpObjSEndTerm[17] + tmpFx[15]*tmpObjSEndTerm[23] + tmpFx[20]*tmpObjSEndTerm[29] + tmpFx[25]*tmpObjSEndTerm[35];
tmpQN2[6] = + tmpFx[1]*tmpObjSEndTerm[0] + tmpFx[6]*tmpObjSEndTerm[6] + tmpFx[11]*tmpObjSEndTerm[12] + tmpFx[16]*tmpObjSEndTerm[18] + tmpFx[21]*tmpObjSEndTerm[24] + tmpFx[26]*tmpObjSEndTerm[30];
tmpQN2[7] = + tmpFx[1]*tmpObjSEndTerm[1] + tmpFx[6]*tmpObjSEndTerm[7] + tmpFx[11]*tmpObjSEndTerm[13] + tmpFx[16]*tmpObjSEndTerm[19] + tmpFx[21]*tmpObjSEndTerm[25] + tmpFx[26]*tmpObjSEndTerm[31];
tmpQN2[8] = + tmpFx[1]*tmpObjSEndTerm[2] + tmpFx[6]*tmpObjSEndTerm[8] + tmpFx[11]*tmpObjSEndTerm[14] + tmpFx[16]*tmpObjSEndTerm[20] + tmpFx[21]*tmpObjSEndTerm[26] + tmpFx[26]*tmpObjSEndTerm[32];
tmpQN2[9] = + tmpFx[1]*tmpObjSEndTerm[3] + tmpFx[6]*tmpObjSEndTerm[9] + tmpFx[11]*tmpObjSEndTerm[15] + tmpFx[16]*tmpObjSEndTerm[21] + tmpFx[21]*tmpObjSEndTerm[27] + tmpFx[26]*tmpObjSEndTerm[33];
tmpQN2[10] = + tmpFx[1]*tmpObjSEndTerm[4] + tmpFx[6]*tmpObjSEndTerm[10] + tmpFx[11]*tmpObjSEndTerm[16] + tmpFx[16]*tmpObjSEndTerm[22] + tmpFx[21]*tmpObjSEndTerm[28] + tmpFx[26]*tmpObjSEndTerm[34];
tmpQN2[11] = + tmpFx[1]*tmpObjSEndTerm[5] + tmpFx[6]*tmpObjSEndTerm[11] + tmpFx[11]*tmpObjSEndTerm[17] + tmpFx[16]*tmpObjSEndTerm[23] + tmpFx[21]*tmpObjSEndTerm[29] + tmpFx[26]*tmpObjSEndTerm[35];
tmpQN2[12] = + tmpFx[2]*tmpObjSEndTerm[0] + tmpFx[7]*tmpObjSEndTerm[6] + tmpFx[12]*tmpObjSEndTerm[12] + tmpFx[17]*tmpObjSEndTerm[18] + tmpFx[22]*tmpObjSEndTerm[24] + tmpFx[27]*tmpObjSEndTerm[30];
tmpQN2[13] = + tmpFx[2]*tmpObjSEndTerm[1] + tmpFx[7]*tmpObjSEndTerm[7] + tmpFx[12]*tmpObjSEndTerm[13] + tmpFx[17]*tmpObjSEndTerm[19] + tmpFx[22]*tmpObjSEndTerm[25] + tmpFx[27]*tmpObjSEndTerm[31];
tmpQN2[14] = + tmpFx[2]*tmpObjSEndTerm[2] + tmpFx[7]*tmpObjSEndTerm[8] + tmpFx[12]*tmpObjSEndTerm[14] + tmpFx[17]*tmpObjSEndTerm[20] + tmpFx[22]*tmpObjSEndTerm[26] + tmpFx[27]*tmpObjSEndTerm[32];
tmpQN2[15] = + tmpFx[2]*tmpObjSEndTerm[3] + tmpFx[7]*tmpObjSEndTerm[9] + tmpFx[12]*tmpObjSEndTerm[15] + tmpFx[17]*tmpObjSEndTerm[21] + tmpFx[22]*tmpObjSEndTerm[27] + tmpFx[27]*tmpObjSEndTerm[33];
tmpQN2[16] = + tmpFx[2]*tmpObjSEndTerm[4] + tmpFx[7]*tmpObjSEndTerm[10] + tmpFx[12]*tmpObjSEndTerm[16] + tmpFx[17]*tmpObjSEndTerm[22] + tmpFx[22]*tmpObjSEndTerm[28] + tmpFx[27]*tmpObjSEndTerm[34];
tmpQN2[17] = + tmpFx[2]*tmpObjSEndTerm[5] + tmpFx[7]*tmpObjSEndTerm[11] + tmpFx[12]*tmpObjSEndTerm[17] + tmpFx[17]*tmpObjSEndTerm[23] + tmpFx[22]*tmpObjSEndTerm[29] + tmpFx[27]*tmpObjSEndTerm[35];
tmpQN2[18] = + tmpFx[3]*tmpObjSEndTerm[0] + tmpFx[8]*tmpObjSEndTerm[6] + tmpFx[13]*tmpObjSEndTerm[12] + tmpFx[18]*tmpObjSEndTerm[18] + tmpFx[23]*tmpObjSEndTerm[24] + tmpFx[28]*tmpObjSEndTerm[30];
tmpQN2[19] = + tmpFx[3]*tmpObjSEndTerm[1] + tmpFx[8]*tmpObjSEndTerm[7] + tmpFx[13]*tmpObjSEndTerm[13] + tmpFx[18]*tmpObjSEndTerm[19] + tmpFx[23]*tmpObjSEndTerm[25] + tmpFx[28]*tmpObjSEndTerm[31];
tmpQN2[20] = + tmpFx[3]*tmpObjSEndTerm[2] + tmpFx[8]*tmpObjSEndTerm[8] + tmpFx[13]*tmpObjSEndTerm[14] + tmpFx[18]*tmpObjSEndTerm[20] + tmpFx[23]*tmpObjSEndTerm[26] + tmpFx[28]*tmpObjSEndTerm[32];
tmpQN2[21] = + tmpFx[3]*tmpObjSEndTerm[3] + tmpFx[8]*tmpObjSEndTerm[9] + tmpFx[13]*tmpObjSEndTerm[15] + tmpFx[18]*tmpObjSEndTerm[21] + tmpFx[23]*tmpObjSEndTerm[27] + tmpFx[28]*tmpObjSEndTerm[33];
tmpQN2[22] = + tmpFx[3]*tmpObjSEndTerm[4] + tmpFx[8]*tmpObjSEndTerm[10] + tmpFx[13]*tmpObjSEndTerm[16] + tmpFx[18]*tmpObjSEndTerm[22] + tmpFx[23]*tmpObjSEndTerm[28] + tmpFx[28]*tmpObjSEndTerm[34];
tmpQN2[23] = + tmpFx[3]*tmpObjSEndTerm[5] + tmpFx[8]*tmpObjSEndTerm[11] + tmpFx[13]*tmpObjSEndTerm[17] + tmpFx[18]*tmpObjSEndTerm[23] + tmpFx[23]*tmpObjSEndTerm[29] + tmpFx[28]*tmpObjSEndTerm[35];
tmpQN2[24] = + tmpFx[4]*tmpObjSEndTerm[0] + tmpFx[9]*tmpObjSEndTerm[6] + tmpFx[14]*tmpObjSEndTerm[12] + tmpFx[19]*tmpObjSEndTerm[18] + tmpFx[24]*tmpObjSEndTerm[24] + tmpFx[29]*tmpObjSEndTerm[30];
tmpQN2[25] = + tmpFx[4]*tmpObjSEndTerm[1] + tmpFx[9]*tmpObjSEndTerm[7] + tmpFx[14]*tmpObjSEndTerm[13] + tmpFx[19]*tmpObjSEndTerm[19] + tmpFx[24]*tmpObjSEndTerm[25] + tmpFx[29]*tmpObjSEndTerm[31];
tmpQN2[26] = + tmpFx[4]*tmpObjSEndTerm[2] + tmpFx[9]*tmpObjSEndTerm[8] + tmpFx[14]*tmpObjSEndTerm[14] + tmpFx[19]*tmpObjSEndTerm[20] + tmpFx[24]*tmpObjSEndTerm[26] + tmpFx[29]*tmpObjSEndTerm[32];
tmpQN2[27] = + tmpFx[4]*tmpObjSEndTerm[3] + tmpFx[9]*tmpObjSEndTerm[9] + tmpFx[14]*tmpObjSEndTerm[15] + tmpFx[19]*tmpObjSEndTerm[21] + tmpFx[24]*tmpObjSEndTerm[27] + tmpFx[29]*tmpObjSEndTerm[33];
tmpQN2[28] = + tmpFx[4]*tmpObjSEndTerm[4] + tmpFx[9]*tmpObjSEndTerm[10] + tmpFx[14]*tmpObjSEndTerm[16] + tmpFx[19]*tmpObjSEndTerm[22] + tmpFx[24]*tmpObjSEndTerm[28] + tmpFx[29]*tmpObjSEndTerm[34];
tmpQN2[29] = + tmpFx[4]*tmpObjSEndTerm[5] + tmpFx[9]*tmpObjSEndTerm[11] + tmpFx[14]*tmpObjSEndTerm[17] + tmpFx[19]*tmpObjSEndTerm[23] + tmpFx[24]*tmpObjSEndTerm[29] + tmpFx[29]*tmpObjSEndTerm[35];
tmpQN1[0] = + tmpQN2[0]*tmpFx[0] + tmpQN2[1]*tmpFx[5] + tmpQN2[2]*tmpFx[10] + tmpQN2[3]*tmpFx[15] + tmpQN2[4]*tmpFx[20] + tmpQN2[5]*tmpFx[25];
tmpQN1[1] = + tmpQN2[0]*tmpFx[1] + tmpQN2[1]*tmpFx[6] + tmpQN2[2]*tmpFx[11] + tmpQN2[3]*tmpFx[16] + tmpQN2[4]*tmpFx[21] + tmpQN2[5]*tmpFx[26];
tmpQN1[2] = + tmpQN2[0]*tmpFx[2] + tmpQN2[1]*tmpFx[7] + tmpQN2[2]*tmpFx[12] + tmpQN2[3]*tmpFx[17] + tmpQN2[4]*tmpFx[22] + tmpQN2[5]*tmpFx[27];
tmpQN1[3] = + tmpQN2[0]*tmpFx[3] + tmpQN2[1]*tmpFx[8] + tmpQN2[2]*tmpFx[13] + tmpQN2[3]*tmpFx[18] + tmpQN2[4]*tmpFx[23] + tmpQN2[5]*tmpFx[28];
tmpQN1[4] = + tmpQN2[0]*tmpFx[4] + tmpQN2[1]*tmpFx[9] + tmpQN2[2]*tmpFx[14] + tmpQN2[3]*tmpFx[19] + tmpQN2[4]*tmpFx[24] + tmpQN2[5]*tmpFx[29];
tmpQN1[5] = + tmpQN2[6]*tmpFx[0] + tmpQN2[7]*tmpFx[5] + tmpQN2[8]*tmpFx[10] + tmpQN2[9]*tmpFx[15] + tmpQN2[10]*tmpFx[20] + tmpQN2[11]*tmpFx[25];
tmpQN1[6] = + tmpQN2[6]*tmpFx[1] + tmpQN2[7]*tmpFx[6] + tmpQN2[8]*tmpFx[11] + tmpQN2[9]*tmpFx[16] + tmpQN2[10]*tmpFx[21] + tmpQN2[11]*tmpFx[26];
tmpQN1[7] = + tmpQN2[6]*tmpFx[2] + tmpQN2[7]*tmpFx[7] + tmpQN2[8]*tmpFx[12] + tmpQN2[9]*tmpFx[17] + tmpQN2[10]*tmpFx[22] + tmpQN2[11]*tmpFx[27];
tmpQN1[8] = + tmpQN2[6]*tmpFx[3] + tmpQN2[7]*tmpFx[8] + tmpQN2[8]*tmpFx[13] + tmpQN2[9]*tmpFx[18] + tmpQN2[10]*tmpFx[23] + tmpQN2[11]*tmpFx[28];
tmpQN1[9] = + tmpQN2[6]*tmpFx[4] + tmpQN2[7]*tmpFx[9] + tmpQN2[8]*tmpFx[14] + tmpQN2[9]*tmpFx[19] + tmpQN2[10]*tmpFx[24] + tmpQN2[11]*tmpFx[29];
tmpQN1[10] = + tmpQN2[12]*tmpFx[0] + tmpQN2[13]*tmpFx[5] + tmpQN2[14]*tmpFx[10] + tmpQN2[15]*tmpFx[15] + tmpQN2[16]*tmpFx[20] + tmpQN2[17]*tmpFx[25];
tmpQN1[11] = + tmpQN2[12]*tmpFx[1] + tmpQN2[13]*tmpFx[6] + tmpQN2[14]*tmpFx[11] + tmpQN2[15]*tmpFx[16] + tmpQN2[16]*tmpFx[21] + tmpQN2[17]*tmpFx[26];
tmpQN1[12] = + tmpQN2[12]*tmpFx[2] + tmpQN2[13]*tmpFx[7] + tmpQN2[14]*tmpFx[12] + tmpQN2[15]*tmpFx[17] + tmpQN2[16]*tmpFx[22] + tmpQN2[17]*tmpFx[27];
tmpQN1[13] = + tmpQN2[12]*tmpFx[3] + tmpQN2[13]*tmpFx[8] + tmpQN2[14]*tmpFx[13] + tmpQN2[15]*tmpFx[18] + tmpQN2[16]*tmpFx[23] + tmpQN2[17]*tmpFx[28];
tmpQN1[14] = + tmpQN2[12]*tmpFx[4] + tmpQN2[13]*tmpFx[9] + tmpQN2[14]*tmpFx[14] + tmpQN2[15]*tmpFx[19] + tmpQN2[16]*tmpFx[24] + tmpQN2[17]*tmpFx[29];
tmpQN1[15] = + tmpQN2[18]*tmpFx[0] + tmpQN2[19]*tmpFx[5] + tmpQN2[20]*tmpFx[10] + tmpQN2[21]*tmpFx[15] + tmpQN2[22]*tmpFx[20] + tmpQN2[23]*tmpFx[25];
tmpQN1[16] = + tmpQN2[18]*tmpFx[1] + tmpQN2[19]*tmpFx[6] + tmpQN2[20]*tmpFx[11] + tmpQN2[21]*tmpFx[16] + tmpQN2[22]*tmpFx[21] + tmpQN2[23]*tmpFx[26];
tmpQN1[17] = + tmpQN2[18]*tmpFx[2] + tmpQN2[19]*tmpFx[7] + tmpQN2[20]*tmpFx[12] + tmpQN2[21]*tmpFx[17] + tmpQN2[22]*tmpFx[22] + tmpQN2[23]*tmpFx[27];
tmpQN1[18] = + tmpQN2[18]*tmpFx[3] + tmpQN2[19]*tmpFx[8] + tmpQN2[20]*tmpFx[13] + tmpQN2[21]*tmpFx[18] + tmpQN2[22]*tmpFx[23] + tmpQN2[23]*tmpFx[28];
tmpQN1[19] = + tmpQN2[18]*tmpFx[4] + tmpQN2[19]*tmpFx[9] + tmpQN2[20]*tmpFx[14] + tmpQN2[21]*tmpFx[19] + tmpQN2[22]*tmpFx[24] + tmpQN2[23]*tmpFx[29];
tmpQN1[20] = + tmpQN2[24]*tmpFx[0] + tmpQN2[25]*tmpFx[5] + tmpQN2[26]*tmpFx[10] + tmpQN2[27]*tmpFx[15] + tmpQN2[28]*tmpFx[20] + tmpQN2[29]*tmpFx[25];
tmpQN1[21] = + tmpQN2[24]*tmpFx[1] + tmpQN2[25]*tmpFx[6] + tmpQN2[26]*tmpFx[11] + tmpQN2[27]*tmpFx[16] + tmpQN2[28]*tmpFx[21] + tmpQN2[29]*tmpFx[26];
tmpQN1[22] = + tmpQN2[24]*tmpFx[2] + tmpQN2[25]*tmpFx[7] + tmpQN2[26]*tmpFx[12] + tmpQN2[27]*tmpFx[17] + tmpQN2[28]*tmpFx[22] + tmpQN2[29]*tmpFx[27];
tmpQN1[23] = + tmpQN2[24]*tmpFx[3] + tmpQN2[25]*tmpFx[8] + tmpQN2[26]*tmpFx[13] + tmpQN2[27]*tmpFx[18] + tmpQN2[28]*tmpFx[23] + tmpQN2[29]*tmpFx[28];
tmpQN1[24] = + tmpQN2[24]*tmpFx[4] + tmpQN2[25]*tmpFx[9] + tmpQN2[26]*tmpFx[14] + tmpQN2[27]*tmpFx[19] + tmpQN2[28]*tmpFx[24] + tmpQN2[29]*tmpFx[29];
}
...
acadoWorkspace.objValueIn[6] = acadoVariables.od[runObj * 22];
acadoWorkspace.objValueIn[7] = acadoVariables.od[runObj * 22 + 1];
acadoWorkspace.objValueIn[8] = acadoVariables.od[runObj * 22 + 2];
acadoWorkspace.objValueIn[9] = acadoVariables.od[runObj * 22 + 3];
acadoWorkspace.objValueIn[10] = acadoVariables.od[runObj * 22 + 4];
acadoWorkspace.objValueIn[11] = acadoVariables.od[runObj * 22 + 5];
acadoWorkspace.objValueIn[12] = acadoVariables.od[runObj * 22 + 6];
acadoWorkspace.objValueIn[13] = acadoVariables.od[runObj * 22 + 7];
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 22 + 8];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 22 + 9];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 22 + 10];
acadoWorkspace.objValueIn[17] = acadoVariables.od[runObj * 22 + 11];
acadoWorkspace.objValueIn[18] = acadoVariables.od[runObj * 22 + 12];
acadoWorkspace.objValueIn[19] = acadoVariables.od[runObj * 22 + 13];
acadoWorkspace.objValueIn[20] = acadoVariables.od[runObj * 22 + 14];
acadoWorkspace.objValueIn[21] = acadoVariables.od[runObj * 22 + 15];
acadoWorkspace.objValueIn[22] = acadoVariables.od[runObj * 22 + 16];
acadoWorkspace.objValueIn[23] = acadoVariables.od[runObj * 22 + 17];
acadoWorkspace.objValueIn[24] = acadoVariables.od[runObj * 22 + 18];
acadoWorkspace.objValueIn[25] = acadoVariables.od[runObj * 22 + 19];
acadoWorkspace.objValueIn[26] = acadoVariables.od[runObj * 22 + 20];
acadoWorkspace.objValueIn[27] = acadoVariables.od[runObj * 22 + 21];
...
setObjQ1Q2( &(acadoWorkspace.objValueOut[ 6 ]), &(acadoVariables.W[ runObj * 36 ]), &(acadoWorkspace.Q1[ runObj * 25 ]), &(acadoWorkspace.Q2[ runObj * 30 ]) );

setObjR1R2( &(acadoWorkspace.objValueOut[ 36 ]), &(acadoVariables.W[ runObj * 36 ]), &(acadoWorkspace.R1[ runObj ]), &(acadoWorkspace.R2[ runObj * 6 ]) );
...
acadoWorkspace.objValueIn[5] = acadoVariables.u[29];
...
{
moveGxT( &(acadoWorkspace.evGx[ lRun1 * 25 ]), acadoWorkspace.T );
multGxd( &(acadoWorkspace.d[ lRun1 * 5-5 ]), &(acadoWorkspace.evGx[ lRun1 * 25 ]), &(acadoWorkspace.d[ lRun1 * 5 ]) );
multGxGx( acadoWorkspace.T, &(acadoWorkspace.evGx[ lRun1 * 25-25 ]), &(acadoWorkspace.evGx[ lRun1 * 25 ]) );
for (lRun2 = 0; lRun2 < lRun1; ++lRun2)
{
lRun4 = (((lRun1) * (lRun1-1)) / (2)) + (lRun2);
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
multGxGu( acadoWorkspace.T, &(acadoWorkspace.E[ lRun4 * 5 ]), &(acadoWorkspace.E[ lRun3 * 5 ]) );
}
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
moveGuE( &(acadoWorkspace.evGu[ lRun1 * 5 ]), &(acadoWorkspace.E[ lRun3 * 5 ]) );
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
multGxGu( &(acadoWorkspace.Q1[ lRun1 * 25 + 25 ]), &(acadoWorkspace.E[ lRun3 * 5 ]), &(acadoWorkspace.QE[ lRun3 * 5 ]) );
}
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ lRun3 * 5 ]), &(acadoWorkspace.QE[ lRun3 * 5 ]) );
}

for (lRun1 = 0; lRun1 < 30; ++lRun1)
{
zeroBlockH10( &(acadoWorkspace.H10[ lRun1 * 5 ]) );
for (lRun2 = lRun1; lRun2 < 30; ++lRun2)
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
multQETGx( &(acadoWorkspace.QE[ lRun3 * 5 ]), &(acadoWorkspace.evGx[ lRun2 * 25 ]), &(acadoWorkspace.H10[ lRun1 * 5 ]) );
}
}
...
setBlockH11( lRun1, lRun2, &(acadoWorkspace.E[ lRun4 * 5 ]), &(acadoWorkspace.QE[ lRun5 * 5 ]) );
}
...
multQ1d( &(acadoWorkspace.Q1[ 25 ]), acadoWorkspace.d, acadoWorkspace.Qd );
multQ1d( &(acadoWorkspace.Q1[ 50 ]), &(acadoWorkspace.d[ 5 ]), &(acadoWorkspace.Qd[ 5 ]) );
multQ1d( &(acadoWorkspace.Q1[ 75 ]), &(acadoWorkspace.d[ 10 ]), &(acadoWorkspace.Qd[ 10 ]) );
multQ1d( &(acadoWorkspace.Q1[ 100 ]), &(acadoWorkspace.d[ 15 ]), &(acadoWorkspace.Qd[ 15 ]) );
multQ1d( &(acadoWorkspace.Q1[ 125 ]), &(acadoWorkspace.d[ 20 ]), &(acadoWorkspace.Qd[ 20 ]) );
multQ1d( &(acadoWorkspace.Q1[ 150 ]), &(acadoWorkspace.d[ 25 ]), &(acadoWorkspace.Qd[ 25 ]) );
multQ1d( &(acadoWorkspace.Q1[ 175 ]), &(acadoWorkspace.d[ 30 ]), &(acadoWorkspace.Qd[ 30 ]) );
multQ1d( &(acadoWorkspace.Q1[ 200 ]), &(acadoWorkspace.d[ 35 ]), &(acadoWorkspace.Qd[ 35 ]) );
multQ1d( &(acadoWorkspace.Q1[ 225 ]), &(acadoWorkspace.d[ 40 ]), &(acadoWorkspace.Qd[ 40 ]) );
multQ1d( &(acadoWorkspace.Q1[ 250 ]), &(acadoWorkspace.d[ 45 ]), &(acadoWorkspace.Qd[ 45 ]) );
multQ1d( &(acadoWorkspace.Q1[ 275 ]), &(acadoWorkspace.d[ 50 ]), &(acadoWorkspace.Qd[ 50 ]) );
multQ1d( &(acadoWorkspace.Q1[ 300 ]), &(acadoWorkspace.d[ 55 ]), &(acadoWorkspace.Qd[ 55 ]) );
multQ1d( &(acadoWorkspace.Q1[ 325 ]), &(acadoWorkspace.d[ 60 ]), &(acadoWorkspace.Qd[ 60 ]) );
multQ1d( &(acadoWorkspace.Q1[ 350 ]), &(acadoWorkspace.d[ 65 ]), &(acadoWorkspace.Qd[ 65 ]) );
multQ1d( &(acadoWorkspace.Q1[ 375 ]), &(acadoWorkspace.d[ 70 ]), &(acadoWorkspace.Qd[ 70 ]) );
multQ1d( &(acadoWorkspace.Q1[ 400 ]), &(acadoWorkspace.d[ 75 ]), &(acadoWorkspace.Qd[ 75 ]) );
multQ1d( &(acadoWorkspace.Q1[ 425 ]), &(acadoWorkspace.d[ 80 ]), &(acadoWorkspace.Qd[ 80 ]) );
multQ1d( &(acadoWorkspace.Q1[ 450 ]), &(acadoWorkspace.d[ 85 ]), &(acadoWorkspace.Qd[ 85 ]) );
multQ1d( &(acadoWorkspace.Q1[ 475 ]), &(acadoWorkspace.d[ 90 ]), &(acadoWorkspace.Qd[ 90 ]) );
multQ1d( &(acadoWorkspace.Q1[ 500 ]), &(acadoWorkspace.d[ 95 ]), &(acadoWorkspace.Qd[ 95 ]) );
multQ1d( &(acadoWorkspace.Q1[ 525 ]), &(acadoWorkspace.d[ 100 ]), &(acadoWorkspace.Qd[ 100 ]) );
multQ1d( &(acadoWorkspace.Q1[ 550 ]), &(acadoWorkspace.d[ 105 ]), &(acadoWorkspace.Qd[ 105 ]) );
multQ1d( &(acadoWorkspace.Q1[ 575 ]), &(acadoWorkspace.d[ 110 ]), &(acadoWorkspace.Qd[ 110 ]) );
multQ1d( &(acadoWorkspace.Q1[ 600 ]), &(acadoWorkspace.d[ 115 ]), &(acadoWorkspace.Qd[ 115 ]) );
multQ1d( &(acadoWorkspace.Q1[ 625 ]), &(acadoWorkspace.d[ 120 ]), &(acadoWorkspace.Qd[ 120 ]) );
multQ1d( &(acadoWorkspace.Q1[ 650 ]), &(acadoWorkspace.d[ 125 ]), &(acadoWorkspace.Qd[ 125 ]) );
multQ1d( &(acadoWorkspace.Q1[ 675 ]), &(acadoWorkspace.d[ 130 ]), &(acadoWorkspace.Qd[ 130 ]) );
multQ1d( &(acadoWorkspace.Q1[ 700 ]), &(acadoWorkspace.d[ 135 ]), &(acadoWorkspace.Qd[ 135 ]) );
multQ1d( &(acadoWorkspace.Q1[ 725 ]), &(acadoWorkspace.d[ 140 ]), &(acadoWorkspace.Qd[ 140 ]) );
multQN1d( acadoWorkspace.QN1, &(acadoWorkspace.d[ 145 ]), &(acadoWorkspace.Qd[ 145 ]) );
...
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
macETSlu( &(acadoWorkspace.QE[ lRun3 * 5 ]), &(acadoWorkspace.g[ lRun1 ]) );
}
}
...
multQDy( &(acadoWorkspace.Q2[ 30 ]), &(acadoWorkspace.Dy[ 6 ]), &(acadoWorkspace.QDy[ 5 ]) );
multQDy( &(acadoWorkspace.Q2[ 60 ]), &(acadoWorkspace.Dy[ 12 ]), &(acadoWorkspace.QDy[ 10 ]) );
multQDy( &(acadoWorkspace.Q2[ 90 ]), &(acadoWorkspace.Dy[ 18 ]), &(acadoWorkspace.QDy[ 15 ]) );
multQDy( &(acadoWorkspace.Q2[ 120 ]), &(acadoWorkspace.Dy[ 24 ]), &(acadoWorkspace.QDy[ 20 ]) );
multQDy( &(acadoWorkspace.Q2[ 150 ]), &(acadoWorkspace.Dy[ 30 ]), &(acadoWorkspace.QDy[ 25 ]) );
multQDy( &(acadoWorkspace.Q2[ 180 ]), &(acadoWorkspace.Dy[ 36 ]), &(acadoWorkspace.QDy[ 30 ]) );
multQDy( &(acadoWorkspace.Q2[ 210 ]), &(acadoWorkspace.Dy[ 42 ]), &(acadoWorkspace.QDy[ 35 ]) );
multQDy( &(acadoWorkspace.Q2[ 240 ]), &(acadoWorkspace.Dy[ 48 ]), &(acadoWorkspace.QDy[ 40 ]) );
multQDy( &(acadoWorkspace.Q2[ 270 ]), &(acadoWorkspace.Dy[ 54 ]), &(acadoWorkspace.QDy[ 45 ]) );
multQDy( &(acadoWorkspace.Q2[ 300 ]), &(acadoWorkspace.Dy[ 60 ]), &(acadoWorkspace.QDy[ 50 ]) );
multQDy( &(acadoWorkspace.Q2[ 330 ]), &(acadoWorkspace.Dy[ 66 ]), &(acadoWorkspace.QDy[ 55 ]) );
multQDy( &(acadoWorkspace.Q2[ 360 ]), &(acadoWorkspace.Dy[ 72 ]), &(acadoWorkspace.QDy[ 60 ]) );
multQDy( &(acadoWorkspace.Q2[ 390 ]), &(acadoWorkspace.Dy[ 78 ]), &(acadoWorkspace.QDy[ 65 ]) );
multQDy( &(acadoWorkspace.Q2[ 420 ]), &(acadoWorkspace.Dy[ 84 ]), &(acadoWorkspace.QDy[ 70 ]) );
multQDy( &(acadoWorkspace.Q2[ 450 ]), &(acadoWorkspace.Dy[ 90 ]), &(acadoWorkspace.QDy[ 75 ]) );
multQDy( &(acadoWorkspace.Q2[ 480 ]), &(acadoWorkspace.Dy[ 96 ]), &(acadoWorkspace.QDy[ 80 ]) );
multQDy( &(acadoWorkspace.Q2[ 510 ]), &(acadoWorkspace.Dy[ 102 ]), &(acadoWorkspace.QDy[ 85 ]) );
multQDy( &(acadoWorkspace.Q2[ 540 ]), &(acadoWorkspace.Dy[ 108 ]), &(acadoWorkspace.QDy[ 90 ]) );
multQDy( &(acadoWorkspace.Q2[ 570 ]), &(acadoWorkspace.Dy[ 114 ]), &(acadoWorkspace.QDy[ 95 ]) );
multQDy( &(acadoWorkspace.Q2[ 600 ]), &(acadoWorkspace.Dy[ 120 ]), &(acadoWorkspace.QDy[ 100 ]) );
multQDy( &(acadoWorkspace.Q2[ 630 ]), &(acadoWorkspace.Dy[ 126 ]), &(acadoWorkspace.QDy[ 105 ]) );
multQDy( &(acadoWorkspace.Q2[ 660 ]), &(acadoWorkspace.Dy[ 132 ]), &(acadoWorkspace.QDy[ 110 ]) );
multQDy( &(acadoWorkspace.Q2[ 690 ]), &(acadoWorkspace.Dy[ 138 ]), &(acadoWorkspace.QDy[ 115 ]) );
multQDy( &(acadoWorkspace.Q2[ 720 ]), &(acadoWorkspace.Dy[ 144 ]), &(acadoWorkspace.QDy[ 120 ]) );
multQDy( &(acadoWorkspace.Q2[ 750 ]), &(acadoWorkspace.Dy[ 150 ]), &(acadoWorkspace.QDy[ 125 ]) );
multQDy( &(acadoWorkspace.Q2[ 780 ]), &(acadoWorkspace.Dy[ 156 ]), &(acadoWorkspace.QDy[ 130 ]) );
multQDy( &(acadoWorkspace.Q2[ 810 ]), &(acadoWorkspace.Dy[ 162 ]), &(acadoWorkspace.QDy[ 135 ]) );
multQDy( &(acadoWorkspace.Q2[ 840 ]), &(acadoWorkspace.Dy[ 168 ]), &(acadoWorkspace.QDy[ 140 ]) );
multQDy( &(acadoWorkspace.Q2[ 870 ]), &(acadoWorkspace.Dy[ 174 ]), &(acadoWorkspace.QDy[ 145 ]) );
...
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
multEQDy( &(acadoWorkspace.E[ lRun3 * 5 ]), &(acadoWorkspace.QDy[ lRun2 * 5 + 5 ]), &(acadoWorkspace.g[ lRun1 ]) );
}
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
multEDu( &(acadoWorkspace.E[ lRun3 * 5 ]), &(acadoWorkspace.x[ lRun2 ]), &(acadoVariables.x[ lRun1 * 5 + 5 ]) );
}
}
}
...
acadoWorkspace.state[36] = acadoVariables.od[index * 22];
acadoWorkspace.state[37] = acadoVariables.od[index * 22 + 1];
acadoWorkspace.state[38] = acadoVariables.od[index * 22 + 2];
acadoWorkspace.state[39] = acadoVariables.od[index * 22 + 3];
acadoWorkspace.state[40] = acadoVariables.od[index * 22 + 4];
acadoWorkspace.state[41] = acadoVariables.od[index * 22 + 5];
acadoWorkspace.state[42] = acadoVariables.od[index * 22 + 6];
acadoWorkspace.state[43] = acadoVariables.od[index * 22 + 7];
acadoWorkspace.state[44] = acadoVariables.od[index * 22 + 8];
acadoWorkspace.state[45] = acadoVariables.od[index * 22 + 9];
acadoWorkspace.state[46] = acadoVariables.od[index * 22 + 10];
acadoWorkspace.state[47] = acadoVariables.od[index * 22 + 11];
acadoWorkspace.state[48] = acadoVariables.od[index * 22 + 12];
acadoWorkspace.state[49] = acadoVariables.od[index * 22 + 13];
acadoWorkspace.state[50] = acadoVariables.od[index * 22 + 14];
acadoWorkspace.state[51] = acadoVariables.od[index * 22 + 15];
acadoWorkspace.state[52] = acadoVariables.od[index * 22 + 16];
acadoWorkspace.state[53] = acadoVariables.od[index * 22 + 17];
acadoWorkspace.state[54] = acadoVariables.od[index * 22 + 18];
acadoWorkspace.state[55] = acadoVariables.od[index * 22 + 19];
acadoWorkspace.state[56] = acadoVariables.od[index * 22 + 20];
acadoWorkspace.state[57] = acadoVariables.od[index * 22 + 21];
...
acadoWorkspace.state[36] = acadoVariables.od[660];
acadoWorkspace.state[37] = acadoVariables.od[661];
acadoWorkspace.state[38] = acadoVariables.od[662];
acadoWorkspace.state[39] = acadoVariables.od[663];
acadoWorkspace.state[40] = acadoVariables.od[664];
acadoWorkspace.state[41] = acadoVariables.od[665];
acadoWorkspace.state[42] = acadoVariables.od[666];
acadoWorkspace.state[43] = acadoVariables.od[667];
acadoWorkspace.state[44] = acadoVariables.od[668];
acadoWorkspace.state[45] = acadoVariables.od[669];
acadoWorkspace.state[46] = acadoVariables.od[670];
acadoWorkspace.state[47] = acadoVariables.od[671];
acadoWorkspace.state[48] = acadoVariables.od[672];
acadoWorkspace.state[49] = acadoVariables.od[673];
acadoWorkspace.state[50] = acadoVariables.od[674];
acadoWorkspace.state[51] = acadoVariables.od[675];
acadoWorkspace.state[52] = acadoVariables.od[676];
acadoWorkspace.state[53] = acadoVariables.od[677];
acadoWorkspace.state[54] = acadoVariables.od[678];
acadoWorkspace.state[55] = acadoVariables.od[679];
acadoWorkspace.state[56] = acadoVariables.od[680];
acadoWorkspace.state[57] = acadoVariables.od[681];
...
acadoWorkspace.objValueIn[6] = acadoVariables.od[lRun1 * 22];
acadoWorkspace.objValueIn[7] = acadoVariables.od[lRun1 * 22 + 1];
acadoWorkspace.objValueIn[8] = acadoVariables.od[lRun1 * 22 + 2];
acadoWorkspace.objValueIn[9] = acadoVariables.od[lRun1 * 22 + 3];
acadoWorkspace.objValueIn[10] = acadoVariables.od[lRun1 * 22 + 4];
acadoWorkspace.objValueIn[11] = acadoVariables.od[lRun1 * 22 + 5];
acadoWorkspace.objValueIn[12] = acadoVariables.od[lRun1 * 22 + 6];
acadoWorkspace.objValueIn[13] = acadoVariables.od[lRun1 * 22 + 7];
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 22 + 8];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 22 + 9];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 22 + 10];
acadoWorkspace.objValueIn[17] = acadoVariables.od[lRun1 * 22 + 11];
acadoWorkspace.objValueIn[18] = acadoVariables.od[lRun1 * 22 + 12];
acadoWorkspace.objValueIn[19] = acadoVariables.od[lRun1 * 22 + 13];
acadoWorkspace.objValueIn[20] = acadoVariables.od[lRun1 * 22 + 14];
acadoWorkspace.objValueIn[21] = acadoVariables.od[lRun1 * 22 + 15];
acadoWorkspace.objValueIn[22] = acadoVariables.od[lRun1 * 22 + 16];
acadoWorkspace.objValueIn[23] = acadoVariables.od[lRun1 * 22 + 17];
acadoWorkspace.objValueIn[24] = acadoVariables.od[lRun1 * 22 + 18];
acadoWorkspace.objValueIn[25] = acadoVariables.od[lRun1 * 22 + 19];
acadoWorkspace.objValueIn[26] = acadoVariables.od[lRun1 * 22 + 20];
acadoWorkspace.objValueIn[27] = acadoVariables.od[lRun1 * 22 + 21];
...
acadoWorkspace.objValueIn[3] = acadoVariables.x[153];
acadoWorkspace.objValueIn[4] = acadoVariables.x[154];
acadoWorkspace.objValueIn[5] = acadoVariables.od[660];
acadoWorkspace.objValueIn[6] = acadoVariables.od[661];
acadoWorkspace.objValueIn[7] = acadoVariables.od[662];
acadoWorkspace.objValueIn[8] = acadoVariables.od[663];
acadoWorkspace.objValueIn[9] = acadoVariables.od[664];
acadoWorkspace.objValueIn[10] = acadoVariables.od[665];
acadoWorkspace.objValueIn[11] = acadoVariables.od[666];
acadoWorkspace.objValueIn[12] = acadoVariables.od[667];
acadoWorkspace.objValueIn[13] = acadoVariables.od[668];
acadoWorkspace.objValueIn[14] = acadoVariables.od[669];
acadoWorkspace.objValueIn[15] = acadoVariables.od[670];
acadoWorkspace.objValueIn[16] = acadoVariables.od[671];
acadoWorkspace.objValueIn[17] = acadoVariables.od[672];
acadoWorkspace.objValueIn[18] = acadoVariables.od[673];
acadoWorkspace.objValueIn[19] = acadoVariables.od[674];
acadoWorkspace.objValueIn[20] = acadoVariables.od[675];
acadoWorkspace.objValueIn[21] = acadoVariables.od[676];
acadoWorkspace.objValueIn[22] = acadoVariables.od[677];
acadoWorkspace.objValueIn[23] = acadoVariables.od[678];
acadoWorkspace.objValueIn[24] = acadoVariables.od[679];
acadoWorkspace.objValueIn[25] = acadoVariables.od[680];
acadoWorkspace.objValueIn[26] = acadoVariables.od[681];
evaluateLSQEndTerm( acadoWorkspace.objValueIn, acadoWorkspace.objValueOut );
