...
% acado inputs
input.od    = repmat([Aw1, Bw1, Cw1, Dw1, Aw2, Bw2, Cw2, Dw2, Aw3, Bw3, Cw3, Dw3, V_cmd, theta_cmd, phi_cmd, kiV],N+1,1);
...
initXh = [repmat(initXh(end,1:8),N+1,1), zeros(N+1,2), zeros(N+1,4), zeros(N+1,5), zeros(N+1,3)];
