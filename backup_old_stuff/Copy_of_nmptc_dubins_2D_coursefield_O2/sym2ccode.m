...
states  = [n,e,mu,xi,mu_dot,intg_e_t,intg_e_chi,sw];
n_X     = length(states);
...
mu_dot_dot = 13.48 * mu_r - 6.577 * mu_dot - 13.97 * mu;
% intg_e_t_dot
% intg_e_chi_dot
% /////////////////////////////////////////////////////////////////////////
...
% state output
y   = [ e_t; e_chi; intg_e_t; intg_e_chi; mu; mu_dot; mu_r; mu_r-mu_r_prev ];
n_Y = length(y);
