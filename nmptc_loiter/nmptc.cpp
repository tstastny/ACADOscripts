...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f2 << sqrt((pow((((-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))+ce+e-e-e)*(-(-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))*dir-((-cn+n)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))+cn+n-n-n)*(-cn+n)*R*dir/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))),2.000000E+00)+pow((-(-(-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))*(cd-d)*dir),2.000000E+00)+pow((-cn+n)*(cd-d)*R*dir/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))),2.000000E+00)));
    acadodata_f2 << asin(((-V)*sin(gamma)+wd)/sqrt((pow(((-V)*sin(gamma)+wd),2.000000E+00)+pow((V*cos(gamma)*cos(xi)+wn),2.000000E+00)+pow((V*cos(gamma)*sin(xi)+we),2.000000E+00))));
    acadodata_f2 << (atan(1/(-(-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))*(-cn+n)*R*dir/dir/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))-atan(1/(V*cos(gamma)*cos(xi)+wn)*(V*cos(gamma)*sin(xi)+we)));
    acadodata_f2 << mu_dot;
    acadodata_f2 << gamma_dot;
    Function acadodata_f3;
    acadodata_f3 << sqrt((pow((((-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))+ce+e-e-e)*(-(-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))*dir-((-cn+n)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))+cn+n-n-n)*(-cn+n)*R*dir/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00)))),2.000000E+00)+pow((-(-(-ce+e)*R/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))))*(cd-d)*dir),2.000000E+00)+pow((-cn+n)*(cd-d)*R*dir/sqrt((pow((-ce+e),2.000000E+00)+pow((-cn+n),2.000000E+00))),2.000000E+00)));
