...
/* Compute outputs: */
out[0] = (((od[0]*a[0])*a[1])+od[1]);
out[1] = (((od[0]*a[2])*a[3])+od[2]);
out[2] = ((((real_t)(0.0000000000000000e+00)-od[0])*a[4])+od[3]);
out[3] = u[0];
out[4] = u[1];
out[5] = (((real_t)(9.8100000000000005e+00)/od[0])*a[5]);
}
...
/* Compute intermediate quantities: */
a[0] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[4])));
a[1] = (cos(xd[5]));
a[2] = (cos(xd[4]));
a[3] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[5])));
a[4] = ((real_t)(-1.0000000000000000e+00)*(sin(xd[4])));
a[5] = (sin(xd[5]));
a[6] = (cos(xd[4]));
a[7] = (cos(xd[5]));
a[8] = (cos(xd[4]));
a[9] = ((real_t)(1.0000000000000000e+00)/(pow((cos(xd[3])),2)));
...
out[20] = (((real_t)(0.0000000000000000e+00)-od[0])*a[8]);
...
out[43] = (((real_t)(9.8100000000000005e+00)/od[0])*a[9]);
...
{
tmp_index1 = (run1 * 6) + (j);
acadoWorkspace.rk_A[tmp_index1 * 12] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 1] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 2] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 3] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 4] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 5] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 5)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 12) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 12 + 6] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 7] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 8] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 9] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 10] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 12 + 11] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 48) + (j * 8 + 5)];
...
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000001e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000001e-01;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 6; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1 + 6)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.0000000000000001e-01 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.0000000000000001e-01;
}
}
