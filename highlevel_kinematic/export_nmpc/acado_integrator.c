...
out[2] = (((real_t)(0.0000000000000000e+00)-xd[3])*a[4]);
out[3] = (((real_t)(0.0000000000000000e+00)-xd[3])+u[0]);
out[4] = (((real_t)(0.0000000000000000e+00)-xd[4])+u[1]);
out[5] = ((((real_t)(9.8100000000000005e+00)*a[5])*a[6])/xd[3]);
out[6] = ((((real_t)(0.0000000000000000e+00)-xd[6])+u[2])/(real_t)(6.9999999999999996e-01));
}
...
out[23] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[8]);
out[24] = (((real_t)(0.0000000000000000e+00)-xd[3])*a[9]);
...
out[44] = ((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00));
...
out[53] = ((real_t)(0.0000000000000000e+00)-((((real_t)(9.8100000000000005e+00)*a[10])*a[11])*a[13]));
out[54] = ((((real_t)(9.8100000000000005e+00)*a[14])*a[11])*a[12]);
out[55] = (real_t)(0.0000000000000000e+00);
out[56] = ((((real_t)(9.8100000000000005e+00)*a[10])*a[15])*a[12]);
...
out[66] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*a[16]);
...
acadoWorkspace.rk_xxx[15] = rk_eta[85];
acadoWorkspace.rk_xxx[16] = rk_eta[86];
acadoWorkspace.rk_xxx[17] = rk_eta[87];
acadoWorkspace.rk_xxx[18] = rk_eta[88];
...
for (i = 0; i < 7; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 10) + (run1 + 7)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
