...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f2 << ((-(-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*cos(chi_p)*cos(gamma_p)-bn+n)*sin(chi_p)-(-(-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*cos(gamma_p)*sin(chi_p)-be+e)*cos(chi_p));
    acadodata_f2 << ((-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*sin(gamma_p)-bd+d);
    acadodata_f2 << gamma_ref;
    acadodata_f2 << mu_ref;
    acadodata_f2 << (-gamma+gamma_ref);
    acadodata_f2 << (-mu+mu_ref)/6.99999999999999955591e-01;
    Function acadodata_f3;
    acadodata_f3 << ((-(-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*cos(chi_p)*cos(gamma_p)-bn+n)*sin(chi_p)-(-(-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*cos(gamma_p)*sin(chi_p)-be+e)*cos(chi_p));
    acadodata_f3 << ((-(-bd+d)*sin(gamma_p)+(-be+e)*cos(gamma_p)*sin(chi_p)+(-bn+n)*cos(chi_p)*cos(gamma_p))*sin(gamma_p)-bd+d);
