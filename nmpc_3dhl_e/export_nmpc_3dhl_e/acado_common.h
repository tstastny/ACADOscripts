...
/** Matrix of size: 81 x 9 (row major format)
 * 
...
/** Matrix of size: 2 x 180 (row major format) */
real_t rk_diffsTemp2[ 360 ];
...
/** Row vector of size: 204 */
real_t state[ 204 ];

/** Column vector of size: 960 */
real_t d[ 960 ];
...
/** Matrix of size: 960 x 12 (row major format) */
real_t evGx[ 11520 ];

/** Matrix of size: 960 x 3 (row major format) */
real_t evGu[ 2880 ];
...
/** Matrix of size: 960 x 11 (row major format) */
real_t Q2[ 10560 ];
...
/** Matrix of size: 12 x 7 (row major format) */
real_t QN2[ 84 ];
...
/** Matrix of size: 38880 x 3 (row major format) */
real_t E[ 116640 ];
