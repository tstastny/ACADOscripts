...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-3.490659E+00) <= mu_dot_cmd <= 3.490659E+00);
    ocp1.subjectTo((-3.490659E+00) <= gamma_dot_cmd <= 3.490659E+00);
    ocp1.subjectTo((-3.490659E+00) <= mu_dot <= 3.490659E+00);
    ocp1.subjectTo((-3.490659E+00) <= gamma_dot <= 3.490659E+00);
    ocp1.setNOD( 15 );
    ocp1.setNP( 0 );
    ocp1.setNU( 2 );
    ocp1.setModel( "model", "rhs", "rhs_jac" );
    ocp1.setDimensions( 0, 8, 0, 0, 0, 2, 15, 0 );
