...
% CONTROLS - - - - - - -
Control mu_dot_cmd;         % (commanded bank angle rate)     [rad]
Control gamma_dot_cmd;      % (commanded fpa rate)            [rad]
...
OnlineData tau_mu_dot;
OnlineData tau_gamma_dot;
...
ocp.subjectTo( -200*pi/180 <= mu_dot_cmd <= 200*pi/180 );
ocp.subjectTo( -200*pi/180 <= gamma_dot_cmd <= 200*pi/180 );
ocp.subjectTo( -200*pi/180 <= mu_dot <= 200*pi/180 );
ocp.subjectTo( -200*pi/180 <= gamma_dot <= 200*pi/180 );
