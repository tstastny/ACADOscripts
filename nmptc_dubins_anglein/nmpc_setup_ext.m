...
DifferentialState x_mu_cmd;
DifferentialState x_gamma_cmd;
...
ocp.subjectTo( -35*pi/180/Ts <= mu_dot <= 35*pi/180/Ts );
ocp.subjectTo( -15*pi/180/Ts <= gamma_dot <= 15*pi/180/Ts );
