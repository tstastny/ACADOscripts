...
acadoWorkspace.rk_xxx[15] = rk_eta[95];
acadoWorkspace.rk_xxx[16] = rk_eta[96];
acadoWorkspace.rk_xxx[17] = rk_eta[97];
acadoWorkspace.rk_xxx[18] = rk_eta[98];
acadoWorkspace.rk_xxx[19] = rk_eta[99];
acadoWorkspace.rk_xxx[20] = rk_eta[100];
acadoWorkspace.rk_xxx[21] = rk_eta[101];
acadoWorkspace.rk_xxx[22] = rk_eta[102];
acadoWorkspace.rk_xxx[23] = rk_eta[103];
acadoWorkspace.rk_xxx[24] = rk_eta[104];
acadoWorkspace.rk_xxx[25] = rk_eta[105];
acadoWorkspace.rk_xxx[26] = rk_eta[106];
acadoWorkspace.rk_xxx[27] = rk_eta[107];
acadoWorkspace.rk_xxx[28] = rk_eta[108];
acadoWorkspace.rk_xxx[29] = rk_eta[109];
acadoWorkspace.rk_xxx[30] = rk_eta[110];
acadoWorkspace.rk_xxx[31] = rk_eta[111];
acadoWorkspace.rk_xxx[32] = rk_eta[112];
acadoWorkspace.rk_xxx[33] = rk_eta[113];
acadoWorkspace.rk_xxx[34] = rk_eta[114];
acadoWorkspace.rk_xxx[35] = rk_eta[115];
...
rhs_jac( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 80 ]) );
for (j = 0; j < 8; ++j)
{
tmp_index1 = (run1 * 8) + (j);
acadoWorkspace.rk_A[tmp_index1 * 16] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 1] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 2] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 3] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 4] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 5] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 6] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 7] = + Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 7)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 16) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 16 + 8] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 9] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 10] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 11] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 12] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 13] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 14] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 16 + 15] = + Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 80) + (j * 10 + 7)];
