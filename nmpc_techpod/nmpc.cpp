...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f3 << (intg_V+sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00))));
    acadodata_f3 << theta;
    acadodata_f3 << phi;
    acadodata_f3 << asin(1/sqrt((pow(u,2.000000E+00)+pow(v,2.000000E+00)+pow(w,2.000000E+00)))*v);
    acadodata_f3 << p;
    acadodata_f3 << q;
    acadodata_f3 << r;
