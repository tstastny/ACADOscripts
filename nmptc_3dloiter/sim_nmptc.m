...
pparams = [1, cc(1), cc(2), cc(3), R, dir, 0, 0, 0];
...
zref        = zeros(1,n_Z);
Q_output    = [1/50];
R_controls  = [5/(15*pi/180) 15/(45*pi/180) 0.1/(100*pi/180) 5/(100*pi/180)];
...
%     Y_rec(k,:)	= [Va_cmd, theta_cmd, phi_cmd, intg_lon, intg_lat, etalon, etalat];
    ...
    % apply control
    [d_states, simout, cost]  = uav3DoF(time(k), states, U0, wn, we, wd, ic_V, tau_mu, tau_gamma, cc, R, dir);
